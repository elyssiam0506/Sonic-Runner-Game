...
var i = (t, e) => Na(t, "name", { value: e, configurable: true });
var so = (() => {
  ...
  return (n) => {
    for (var r = n.length, o = new Uint8Array((r - (n[r - 1] == "=") - (n[r - 2] == "=")) * 3 / 4 | 0), s = 0, a = 0; s < r; ) {
      var l = t[n.charCodeAt(s++)], u = t[n.charCodeAt(s++)], m = t[n.charCodeAt(s++)], c = t[n.charCodeAt(s++)];
...
var H = (_a = class {
  ...
  lerp(e, n) {
    return new _a(Ee(this.r, e.r, n), Ee(this.g, e.g, n), Ee(this.b, e.b, n));
  }
  toHSL() {
...
function W(...t) {
  if (t.length === 0) return new H(255, 255, 255);
  if (t.length === 1) {
    if (t[0] instanceof H) return t[0].clone();
    if (typeof t[0] == "string") return H.fromHex(t[0]);
    if (Array.isArray(t[0]) && t[0].length === 3) return H.fromArray(t[0]);
  } else if (t.length === 2) {
    if (t[0] instanceof H) return t[0].clone();
  } else if (t.length === 3 || t.length === 4) return new H(t[0], t[1], t[2]);
  throw new Error("Invalid color arguments");
}
i(W, "rgb");
var ao = i((t, e, n) => H.fromHSL(t, e, n), "hsl2rgb");
function ce(t) {
...
i(pt, "rad2deg");
function Be(t, e, n) {
  return e > n ? Be(t, n, e) : Math.min(Math.max(t, e), n);
}
i(Be, "clamp");
function Ee(t, e, n) {
  if (typeof t == "number" && typeof e == "number") return t + (e - t) * n;
  if (t instanceof w && e instanceof w) return t.lerp(e, n);
  if (t instanceof H && e instanceof H) return t.lerp(e, n);
...
var w = (_a2 = class {
  ...
  lerp(e, n) {
    return new _a2(Ee(this.x, e.x, n), Ee(this.y, e.y, n));
  }
  slerp(e, n) {
...
}, i(_a2, "Vec2"), __publicField(_a2, "LEFT", new _a2(-1, 0)), __publicField(_a2, "RIGHT", new _a2(1, 0)), __publicField(_a2, "UP", new _a2(0, -1)), __publicField(_a2, "DOWN", new _a2(0, 1)), _a2);
function b(...t) {
  if (t.length === 1) {
    if (t[0] instanceof w) return new w(t[0].x, t[0].y);
    if (Array.isArray(t[0]) && t[0].length === 2) return new w(...t[0]);
  }
  return new w(...t);
}
i(b, "vec2");
...
var ge = (_a6 = class {
  ...
  invert() {
    let e = [], n = this.m[10] * this.m[15] - this.m[14] * this.m[11], r = this.m[9] * this.m[15] - this.m[13] * this.m[11], o = this.m[9] * this.m[14] - this.m[13] * this.m[10], s = this.m[8] * this.m[15] - this.m[12] * this.m[11], a = this.m[8] * this.m[14] - this.m[12] * this.m[10], l = this.m[8] * this.m[13] - this.m[12] * this.m[9], u = this.m[6] * this.m[15] - this.m[14] * this.m[7], m = this.m[5] * this.m[15] - this.m[13] * this.m[7], c = this.m[5] * this.m[14] - this.m[13] * this.m[6], p = this.m[4] * this.m[15] - this.m[12] * this.m[7], d = this.m[4] * this.m[14] - this.m[12] * this.m[6], x = this.m[5] * this.m[15] - this.m[13] * this.m[7], f = this.m[4] * this.m[13] - this.m[12] * this.m[5], y = this.m[6] * this.m[11] - this.m[10] * this.m[7], v = this.m[5] * this.m[11] - this.m[9] * this.m[7], A = this.m[5] * this.m[10] - this.m[9] * this.m[6], V = this.m[4] * this.m[11] - this.m[8] * this.m[7], M = this.m[4] * this.m[10] - this.m[8] * this.m[6], G = this.m[4] * this.m[9] - this.m[8] * this.m[5];
    e[0] = this.m[5] * n - this.m[6] * r + this.m[7] * o, e[4] = -(this.m[4] * n - this.m[6] * s + this.m[7] * a), e[8] = this.m[4] * r - this.m[5] * s + this.m[7] * l, e[12] = -(this.m[4] * o - this.m[5] * a + this.m[6] * l), e[1] = -(this.m[1] * n - this.m[2] * r + this.m[3] * o), e[5] = this.m[0] * n - this.m[2] * s + this.m[3] * a, e[9] = -(this.m[0] * r - this.m[1] * s + this.m[3] * l), e[13] = this.m[0] * o - this.m[1] * a + this.m[2] * l, e[2] = this.m[1] * u - this.m[2] * m + this.m[3] * c, e[6] = -(this.m[0] * u - this.m[2] * p + this.m[3] * d), e[10] = this.m[0] * x - this.m[1] * p + this.m[3] * f, e[14] = -(this.m[0] * c - this.m[1] * d + this.m[2] * f), e[3] = -(this.m[1] * y - this.m[2] * v + this.m[3] * A), e[7] = this.m[0] * y - this.m[2] * V + this.m[3] * M, e[11] = -(this.m[0] * v - this.m[1] * V + this.m[3] * G), e[15] = this.m[0] * A - this.m[1] * M + this.m[2] * G;
    let F = this.m[0] * e[0] + this.m[1] * e[4] + this.m[2] * e[8] + this.m[3] * e[12];
    for (let g = 0; g < 4; g++) for (let T = 0; T < 4; T++) e[g * 4 + T] *= 1 / F;
    return new _a6(e);
  }
  clone() {
...
function xn(t, e, n, r = (o) => -Math.cos(o)) {
...
var Wt = (_a7 = class {
  ...
  genAny(...e) {
    ...
    if (e.length === 1) {
      ...
      if (e[0] instanceof w) return this.genVec2(b(0, 0), e[0]);
      if (e[0] instanceof H) return this.genColor(W(0, 0, 0), e[0]);
    } else if (e.length === 2) {
      if (typeof e[0] == "number" && typeof e[1] == "number") return this.genNumber(e[0], e[1]);
      if (e[0] instanceof w && e[1] instanceof w) return this.genVec2(e[0], e[1]);
...
function lo(t) {
  return t != null && (lr.seed = t), lr.seed;
}
i(lo, "randSeed");
function be(...t) {
  return lr.genAny(...t);
...
i(pr, "shuffle");
function po(t, e) {
  return t.length <= e ? t.slice() : pr(t.slice()).slice(0, e);
}
i(po, "chooseMultiple");
function ho(t) {
  return t[mr(t.length)];
}
i(ho, "choose");
function dr(t, e) {
...
function vn(t, e) {
  let n = za(t, e);
  return n ? b(t.p1.x + n * (t.p2.x - t.p1.x), t.p1.y + n * (t.p2.y - t.p1.y)) : null;
}
i(vn, "testLineLine");
function wn(t, e) {
...
i(fo, "testRectCircle");
function go(t, e) {
  return bo(e, new Se(t.points()));
}
i(go, "testRectPolygon");
function En(t, e) {
...
i(En, "testLinePoint");
function Mt(t, e) {
  let n = t.p2.sub(t.p1), r = n.dot(n), o = t.p1.sub(e.center), s = 2 * n.dot(o), a = o.dot(o) - e.radius * e.radius, l = s * s - 4 * r * a;
...
function $t(t, e) {
  ...
  for (let r of e.pts) {
    if (Mt(new Ae(n, r), t)) return true;
    n = r;
  }
  return Tn(t, e.pts[0]) ? true : rt(e, t.center);
}
i($t, "testCirclePolygon");
function bo(t, e) {
  for (let n = 0; n < t.pts.length; n++) if (hr(new Ae(t.pts[n], t.pts[(n + 1) % t.pts.length]), e)) return true;
  return !!(t.pts.some((n) => rt(e, n)) || e.pts.some((n) => rt(t, n)));
}
...
function fr(t, e) {
  e = e.sub(t.center);
  let n = ce(t.angle), r = Math.cos(n), o = Math.sin(n), s = e.x * r + e.y * o, a = -e.x * o + e.y * r;
  return s * s / (t.radiusX * t.radiusX) + a * a / (t.radiusY * t.radiusY) < 1;
}
i(fr, "testEllipsePoint");
function bn(t, e) {
  let n = e.center.sub(t.center), r = ce(t.angle), o = Math.cos(r), s = Math.sin(r), a = n.x * o + n.y * s, l = -n.x * s + n.y * o;
  return fr(new _e(b(), t.radiusX + e.radius, t.radiusY + e.radius, 0), b(a, l));
}
i(bn, "testEllipseCircle");
function yo(t, e) {
  let n = t.toMat2().inverse;
  return e = new Ae(n.transform(e.p1.sub(t.center)), n.transform(e.p2.sub(t.center))), Mt(e, new Ge(b(), 1));
}
i(yo, "testEllipseLine");
function Wa(t, e) {
  if (t.radiusX === t.radiusY) return bn(e, new Ge(t.center, t.radiusX));
  if (e.radiusX === e.radiusY) return bn(t, new Ge(e.center, e.radiusX));
  let n = new yt(1 / t.radiusX ** 2, 0, 0, 0, 1 / t.radiusY ** 2, 0, 0, 0, -1), r = new yt(1 / e.radiusX ** 2, 0, 0, 0, 1 / e.radiusY ** 2, 0, 0, 0, -1), o = t.center.x, s = t.center.y, a = e.center.x, l = e.center.y, u = ce(t.angle), m = ce(e.angle), c = new yt(Math.cos(u), -Math.sin(u), o, Math.sin(u), Math.cos(u), s, 0, 0, 1), p = new yt(Math.cos(m), -Math.sin(m), a, Math.sin(m), Math.cos(m), l, 0, 0, 1), d = c.inverse, x = p.inverse, f = d.transpose.mul(n).mul(d), y = x.transpose.mul(r).mul(x), v = f.m11, A = f.m12, V = f.m13, M = f.m21, G = f.m22, F = f.m23, g = f.m31, T = f.m32, S = f.m33, D = y.m11, B = y.m12, K = y.m13, k = y.m21, z = y.m22, X = y.m23, te = y.m31, Q = y.m32, q = y.m33, ae = v * G * S - v * F * T - A * M * S + A * F * g + V * M * T - V * G * g, U = (v * G * q - v * F * Q - v * T * X + v * S * z - A * M * q + A * F * te + A * g * X - A * S * k + V * M * Q - V * G * te - V * g * z + V * T * k + M * T * K - M * S * B - G * g * K + G * S * D + F * g * B - F * T * D) / ae, I = (v * z * q - v * X * Q - A * k * q + A * X * te + V * k * Q - V * z * te - M * B * q + M * K * Q + G * D * q - G * K * te - F * D * Q + F * B * te + g * B * X - g * K * z - T * D * X + T * K * k + S * D * z - S * B * k) / ae, Y = (D * z * q - D * X * Q - B * k * q + B * X * te + K * k * Q - K * z * te) / ae;
  if (U >= 0) {
    let j = -3 * I + U ** 2, ue = 3 * U * Y + I * U ** 2 - 4 * I ** 2, Z = -27 * Y ** 2 + 18 * Y * U * I + U ** 2 * I ** 2 - 4 * U ** 3 * Y - 4 * I ** 3;
    return !(j > 0 && ue < 0 && Z > 0);
  } else {
    let j = -3 * I + U ** 2, ue = -27 * Y ** 2 + 18 * Y * U * I + U ** 2 * I ** 2 - 4 * U ** 3 * Y - 4 * I ** 3;
    return !(j > 0 && ue > 0);
  }
}
i(Wa, "testEllipseEllipse");
function xo(t, e) {
  return gr(t, new Se(e.points()));
}
i(xo, "testEllipseRect");
function gr(t, e) {
  let n = t.toMat2().inverse;
  return e = new Se(e.pts.map((r) => n.transform(r.sub(t.center)))), $t(new Ge(b(), 1), e);
}
...
i($a, "testPointPoint");
function Xa(t, e) {
  return e instanceof w ? $a(e, t.pt) : e instanceof Ge ? Tn(e, t.pt) : e instanceof Ae ? En(e, t.pt) : e instanceof ee ? Cn(e, t.pt) : e instanceof Se ? rt(e, t.pt) : e instanceof _e ? fr(e, t.pt) : false;
}
i(Xa, "testPointShape");
function Qa(t, e) {
  return e instanceof w ? En(t, e) : e instanceof Ge ? Mt(t, e) : e instanceof Ae ? vn(t, e) != null : e instanceof ee ? wn(e, t) : e instanceof Se ? hr(t, e) : e instanceof _e ? yo(e, t) : false;
}
i(Qa, "testLineShape");
function Ja(t, e) {
  return e instanceof w ? Tn(t, e) : e instanceof Ge ? Ya(t, e) : e instanceof Ae ? Mt(e, t) : e instanceof ee ? fo(e, t) : e instanceof Se ? $t(t, e) : e instanceof _e ? bn(e, t) : false;
}
i(Ja, "testCircleShape");
function Za(t, e) {
  return e instanceof w ? Cn(t, e) : e instanceof Ge ? fo(t, e) : e instanceof Ae ? wn(t, e) : e instanceof ee ? dr(t, e) : e instanceof Se ? go(t, e) : e instanceof _e ? xo(e, t) : false;
}
i(Za, "testRectShape");
function eu(t, e) {
  return e instanceof w ? rt(t, e) : e instanceof Ge ? $t(e, t) : e instanceof Ae ? hr(e, t) : e instanceof ee ? go(e, t) : e instanceof Se ? bo(e, t) : e instanceof _e ? gr(e, t) : false;
}
i(eu, "testPolygonShape");
function tu(t, e) {
  return e instanceof w ? fr(t, e) : e instanceof Ge ? bn(t, e) : e instanceof Ae ? yo(t, e) : e instanceof ee ? xo(t, e) : e instanceof Se ? gr(t, e) : e instanceof _e ? Wa(e, t) : false;
}
i(tu, "testEllipseShape");
function vo(t, e, n) {
  let r = t, o = n.p1, s = n.p2, a = e, l = s.sub(o), u = a.cross(l);
...
i(nu, "raycastRect");
function wo(t, e, n) {
  let r = t, o = n.center, s = e, a = s.dot(s), l = r.sub(o), u = 2 * s.dot(l), m = l.dot(l) - n.radius * n.radius, c = u * u - 4 * a * m;
...
i(ru, "raycastPolygon");
function ou(t, e, n) {
  let r = n.toMat2(), o = r.inverse, s = o.transform(t.sub(n.center)), a = o.transform(e), l = wo(s, a, new Ge(b(), 1));
  if (l) {
    let u = Dt.rotation(ce(-n.angle)), c = Dt.scale(n.radiusX, n.radiusY).transform(l.point), p = r.transform(l.point).add(n.center), d = p.dist(t) / e.len();
    return { point: p, normal: u.transform(b(n.radiusY ** 2 * c.x, n.radiusX ** 2 * c.y)).unit(), fraction: d };
  }
  return l;
}
i(ou, "raycastEllipse");
function Co(t, e, n, r = 64) {
  let o = t, s = e.len(), a = e.scale(1 / s), l = 0, u = b(Math.floor(t.x), Math.floor(t.y)), m = b(a.x > 0 ? 1 : -1, a.y > 0 ? 1 : -1), c = b(Math.abs(1 / a.x), Math.abs(1 / a.y)), p = b(m.x > 0 ? u.x + 1 - t.x : t.x - u.x, m.y > 0 ? u.y + 1 - t.y : t.y - u.y), d = b(c.x < 1 / 0 ? c.x * p.x : 1 / 0, c.y < 1 / 0 ? c.y * p.y : 1 / 0), x = -1;
  for (; l <= r; ) {
    let f = n(u);
    if (f === true) return { point: o.add(a.scale(l)), normal: b(x === 0 ? -m.x : 0, x === 1 ? -m.y : 0), fraction: l / s, gridPos: u };
    if (f) return f;
...
var ee = (_a10 = class {
  ...
  transform(e) {
    return new Se(this.points().map((n) => e.multVec2(n)));
  }
  bbox() {
    return this.clone();
  }
...
var Ge = (_a11 = class {
  ...
  random() {
    return this.center.add(w.fromAngle(be(360)).scale(be(this.radius)));
  }
}, i(_a11, "Circle"), _a11);
var _a12;
var _e = (_a12 = class {
  ...
  static fromMat2(e) {
    ...
    return u > m ? new _a12(b(), u, m, pt(Math.atan2(-a[1], a[0]))) : new _a12(b(), m, u, pt(Math.atan2(-l[1], l[0])));
  }
  toMat2() {
  ...
  bbox() {
    if (this.angle == 0) return ee.fromPoints(this.center.sub(b(this.radiusX, this.radiusY)), this.center.add(b(this.radiusX, this.radiusY)));
    {
...
var Se = (_a13 = class {
  ...
  cut(e, n) {
    let r = new Ae(e, n), o = [], s = [], a = n.sub(e), l = this.pts[this.pts.length - 1], u = l.sub(e), m = a.cross(u) > 0;
    return this.pts.forEach((c) => {
      ...
      (p ? o : s).push(c), l = c;
    }), [o.length ? new _a13(o) : null, s.length ? new _a13(s) : null];
  }
}, i(_a13, "Polygon"), _a13);
function Eo(t, e, n, r) {
...
function Xt(t, e, n, r, o) {
  ...
  return t.scale(m).add(e.scale(3 * u * o)).add(n.scale(3 * l * s)).add(r.scale(a));
}
i(Xt, "evaluateBezier");
function Ao(t, e, n, r, o) {
  let s = o * o, a = 1 - o, l = a * a;
  return e.sub(t).scale(3 * l).add(n.sub(e).scale(6 * a * o)).add(r.sub(n).scale(3 * s));
}
...
function Vo(t, e, n, r, o) {
  ...
  return t.scale(s).add(e.scale(a)).add(n.scale(l)).add(r.scale(u));
}
...
function br(t, e = 10, n = 10) {
  let r = [0], o = [0], a = 1 / (e - 1) / n, l = 0, u = t(0), m = 0;
  for (let c = 1; c < e; c++) {
    for (let p = 0; p < n; p++) {
      m += a;
      let d = t(m), x = d.dist(u);
      l += x, u = d;
    }
    r[c] = l, o[c] = m;
  }
...
function Ut(t, e, n, r) {
  let o = 2 * t + e - 2 * r + n, s = -3 * t + 3 * r - 2 * e - n, a = e, l = t;
  return (u) => {
    let m = u * u, c = m * u;
...
i(Ut, "hermite");
function yr(t, e, n, r, o, s = Ut) {
  let a = s(e.x, (1 - o) * (n.x - t.x), (1 - o) * (r.x - e.x), n.x), l = s(e.y, (1 - o) * (n.y - t.y), (1 - o) * (r.y - e.y), n.y);
  return (u) => new w(a(u), l(u));
}
i(yr, "cardinal");
function Bt(t, e, n, r, o = Ut) {
  return yr(t, e, n, r, 0.5, o);
}
i(Bt, "catmullRom");
function Go(t, e, n, r, o = Ut) {
  return Bt(r.add(t.sub(e).scale(6)), t, r, t.add(r.sub(n).scale(6)), o);
}
i(Go, "bezier");
function Do(t, e, n, r, o, s, a, l = Ut) {
  let u = l(e.x, 0.5 * (1 - o) * (1 + a) * (1 + s) * (e.x - t.x) + 0.5 * (1 - o) * (1 - a) * (1 - s) * (n.x - e.x), 0.5 * (1 - o) * (1 + a) * (1 - s) * (n.x - e.x) + 0.5 * (1 - o) * (1 - a) * (1 + s) * (r.x - n.x), n.x), m = l(e.y, 0.5 * (1 - o) * (1 + a) * (1 + s) * (e.y - t.y) + 0.5 * (1 - o) * (1 - a) * (1 - s) * (n.y - e.y), 0.5 * (1 - o) * (1 + a) * (1 - s) * (n.y - e.y) + 0.5 * (1 - o) * (1 - a) * (1 + s) * (r.y - n.y), n.y);
...
i(Yt, "cubeRoot");
function su(t, e, n, r) {
  let o = 3 * t - 6 * e + 3 * n, s = -3 * t + 3 * e, a = t, l = -t + 3 * e - 3 * n + r;
  if (ur(l, 0)) {
    if (ur(o, 0)) return ur(s, 0) ? [] : [-a / s].filter(zt);
  ...
  if (d < 0) {
    let A = -u / 3, V = A * A * A, M = Math.sqrt(V), G = -c / (2 * M), F = G < -1 ? -1 : G > 1 ? 1 : G, g = Math.acos(F), S = 2 * Yt(M), D = S * Math.cos(g / 3) - o / 3, B = S * Math.cos((g + 2 * Math.PI) / 3) - o / 3, K = S * Math.cos((g + 4 * Math.PI) / 3) - o / 3;
    return [D, B, K].filter(zt);
  }
  if (d === 0) {
    let A = p < 0 ? Yt(-p) : -Yt(p), V = 2 * A - o / 3, M = -A - o / 3;
    return [V, M].filter(zt);
  }
...
function au(t, e, n, r, o) {
  let s = su(t.x - o, e.x - o, n.x - o, r.x - o);
  return s.length > 0 ? Xt(t, e, n, r, s[0]).y : NaN;
}
...
function Uo(t) {
  ...
  return (n) => {
    ...
    for (let r = 0; r < e; r++) if (t[r].x >= n) return De(n, t[r - 1].x, t[r].x, t[r - 1].y, t[r].y);
    return t[t.length - 1].y;
  };
}
i(Uo, "easingLinear");
function Bo(t, e) {
  return (n) => au(b(0, 0), t, e, b(1, 1), n);
}
i(Bo, "easingCubicBezier");
function Fo(t, e = "jump-end") {
...
function cr(t, e, n, r) {
  let o = r.x - n.x, s = r.y - n.y, a = o * (t.y - n.y) - s * (t.x - n.x), l = o * (e.y - n.y) - s * (e.x - n.x);
  return a * l >= 0;
}
i(cr, "onSameSide");
function cu(t, e, n, r) {
...
function On(t) {
  ...
  e[e.length - 1] = 0, n[0] = n.length - 1, uu(t) || ([e, n] = [n, e]);
  let o = [];
  for (let p = 0; p < t.length; ++p) Io(t[n[p]], t[p], t[e[p]]) || o.push(t[p]);
  let s = [], a = t.length, l = 1, u = 0, m, c;
  for (; a > 3; ) {
    m = e[l], c = n[l];
    let p = t[c], d = t[l], x = t[m];
    if (mu(p, d, x, o)) s.push([p, d, x]), e[c] = m, n[m] = c, o.splice(o.indexOf(d), 1), --a, u = 0;
    else if (++u > a) return [];
    l = m;
  }
  return m = e[l], c = n[l], s.push([t[c], t[l], t[m]]), s;
}
i(On, "triangulate");
function jo(t) {
...
i(jo, "isConvex");
var Ko = i((t) => t[0] instanceof H, "arrayIsColor");
var ko = i((t) => t[0] instanceof w, "arrayIsVec2");
var _o = i((t) => typeof t[0] == "number", "arrayIsNumber");
function No(t) {
...
i(An, "download");
function xr(t, e) {
  An(t, "data:text/plain;charset=utf-8," + e);
}
i(xr, "downloadText");
function qo(t, e) {
  xr(t, JSON.stringify(e));
}
i(qo, "downloadJSON");
function vr(t, e) {
  let n = URL.createObjectURL(e);
  An(t, n), URL.revokeObjectURL(n);
}
i(vr, "downloadBlob");
var Sn = i((t) => t.match(/^data:\w+\/\w+;base64,.+/), "isDataURL");
var zo = i((t) => t.split(".").slice(0, -1).join("."), "getFileName");
function Vn(t, e) {
  if (t === e) return true;
...
var $e = (_a18 = class {
  ...
  numListeners(e) {
    var _a40;
    return ((_a40 = this.handlers[e]) == null ? void 0 : _a40.numListeners()) ?? 0;
  }
}, i(_a18, "KEventHandler"), _a18);
var Yo = i((t) => t instanceof Error ? t.message : String(t), "getErrorMessage");
function Jt(t, e) {
...
function $o(t) {
  ...
  let e = [], n = 0, r = 0;
  for (; n < t.length; ) {
    if (r += hu(n + r, t), wu(t[n + r]) && r++, yu(t[n + r]) && r++, xu(t[n + r]) && r++, Cu(t[n + r])) {
      r++;
      continue;
    }
...
function hu(t, e) {
  let n = e[t];
  if (!fu(n) || t === e.length - 1) return 1;
  let r = n + e[t + 1], o = e.substring(t + 2, t + 5);
  return Wo(r) && Wo(o) ? 4 : gu(r) && vu(o) ? e.slice(t).indexOf(String.fromCodePoint(917631)) + 2 : bu(o) ? 4 : 2;
}
i(hu, "nextUnits");
function fu(t) {
...
function Wo(t) {
  return xt(wr(t), 127462, 127487);
}
i(Wo, "isRegionalIndicator");
function gu(t) {
  return xt(wr(t), 127988, 127988);
}
i(gu, "isSubdivisionFlag");
function bu(t) {
  return xt(wr(t), 127995, 127999);
}
...
function wu(t) {
  return typeof t == "string" && du.includes(t.charCodeAt(0));
}
i(wu, "isGrapheme");
function Cu(t) {
...
var Fe = i((t, e) => Array.isArray(t) ? t == null ? void 0 : t.includes(e) : t === e, "isEqOrIncludes");
var Xe = i((t, e) => Array.isArray(e) ? e.some((n) => t.has(n)) : t.has(e), "setHasOrIncludes");
var Pn = i((t, e, n) => {
  var _a40;
  t.has(e) ? (_a40 = t.get(e)) == null ? void 0 : _a40.push(n) : t.set(e, [n]);
}, "mapAddOrPush");
var Xo = /* @__PURE__ */ (() => {
  let t = 0;
  return () => t++;
...
var Jo = i(() => {
  let t = vt.buttons;
  for (let e in t) {
    let n = t[e].keyboard && [t[e].keyboard].flat(), r = t[e].gamepad && [t[e].gamepad].flat(), o = t[e].mouse && [t[e].mouse].flat();
    n && n.forEach((s) => {
...
}, i(_a19, "ButtonState"), _a19);
var _a20;
var Er = (_a20 = class {
  constructor() {
    __publicField(this, "buttonState", new wt());
    __publicField(this, "stickState", /* @__PURE__ */ new Map());
  }
}, i(_a20, "GamepadState"), _a20);
var _a21;
var Tr = (_a21 = class {
  constructor() {
...
var Zo = i((t) => {
  ...
  function V() {
    e.stopped = true;
    let h = Object.entries(Ue), E = Object.entries(sr), R = Object.entries(gn);
    for (let [N, ie] of h) e.canvas.removeEventListener(N, ie);
    for (let [N, ie] of E) document.removeEventListener(N, ie);
    for (let [N, ie] of R) window.removeEventListener(N, ie);
    io.disconnect();
  }
  i(V, "quit");
  function M(h, E) {
    ...
    let R = 0, N = 0, ie = i((Re) => {
      ...
      let se = Re / 1e3, nt = Math.min(se - e.realTime, 0.25), bt = t.maxFPS ? 1 / t.maxFPS : 0;
      if (e.realTime = se, N += nt, N > bt) {
        if (!e.skipTime) {
          for (R += N, e.dt = e.fixedDt, e.restDt = 0; R > e.fixedDt; ) R -= e.fixedDt, R < e.fixedDt && (e.restDt = R), h();
  ...
  i(ue, "onResize");
  let Z = de((h) => e.events.on("keyDown", h), (h, E) => e.events.on("keyDown", (R) => Fe(h, R) && E(R))), Ce = de((h) => e.events.on("keyPress", (E) => h(E)), (h, E) => e.events.on("keyPress", (R) => Fe(h, R) && E(R))), Ht = de((h) => e.events.on("keyPressRepeat", h), (h, E) => e.events.on("keyPressRepeat", (R) => Fe(h, R) && E(R))), lt = de((h) => e.events.on("keyRelease", h), (h, E) => e.events.on("keyRelease", (R) => Fe(h, R) && E(R))), nr = de((h) => e.events.on("mouseDown", (E) => h(E)), (h, E) => e.events.on("mouseDown", (R) => Fe(h, R) && E(R))), rr = de((h) => e.events.on("mousePress", (E) => h(E)), (h, E) => e.events.on("mousePress", (R) => Fe(h, R) && E(R))), or = de((h) => e.events.on("mouseRelease", (E) => h(E)), (h, E) => e.events.on("mouseRelease", (R) => R === h && E(R)));
  function ir(h) {
  ...
  i(ja, "resetInput");
  function to(h) {
    let E = { index: h.index, isPressed: i((R) => {
      var _a41;
      return ((_a41 = e.gamepadStates.get(h.index)) == null ? void 0 : _a41.buttonState.pressed.has(R)) || false;
    }, "isPressed"), isDown: i((R) => {
      var _a41;
      return ((_a41 = e.gamepadStates.get(h.index)) == null ? void 0 : _a41.buttonState.down.has(R)) || false;
    }, "isDown"), isReleased: i((R) => {
      var _a41;
      return ((_a41 = e.gamepadStates.get(h.index)) == null ? void 0 : _a41.buttonState.released.has(R)) || false;
    }, "isReleased"), getStick: i((R) => {
      var _a41;
      return ((_a41 = e.gamepadStates.get(h.index)) == null ? void 0 : _a41.stickState.get(R)) || b();
    }, "getStick") };
  ...
  function ka() {
    var _a41, _b, _c;
    for (let h of navigator.getGamepads()) h && !e.gamepadStates.has(h.index) && to(h);
    for (let h of e.gamepads) {
      let E = navigator.getGamepads()[h.index];
      if (!E) continue;
      let N = (t.gamepads ?? {})[E.id] ?? Cr[E.id] ?? Cr.default, ie = e.gamepadStates.get(h.index);
      if (ie) {
        for (let Re = 0; Re < E.buttons.length; Re++) {
          let se = N.buttons[Re], nt = E.buttons[Re], bt = e.buttonsByGamepad.has(se);
          nt.pressed ? (ie.buttonState.down.has(se) || (e.lastInputDevice = "gamepad", bt && ((_a41 = e.buttonsByGamepad.get(se)) == null ? void 0 : _a41.forEach((Oe) => {
            e.buttonState.press(Oe), e.events.trigger("buttonPress", Oe);
          })), e.mergedGamepadState.buttonState.press(se), ie.buttonState.press(se), e.events.trigger("gamepadButtonPress", se)), bt && ((_b = e.buttonsByGamepad.get(se)) == null ? void 0 : _b.forEach((Oe) => {
            e.buttonState.press(Oe), e.events.trigger("buttonDown", Oe);
          })), e.events.trigger("gamepadButtonDown", se)) : ie.buttonState.down.has(se) && (bt && ((_c = e.buttonsByGamepad.get(se)) == null ? void 0 : _c.forEach((Oe) => {
            e.buttonState.release(Oe), e.events.trigger("buttonRelease", Oe);
          })), e.mergedGamepadState.buttonState.release(se), ie.buttonState.release(se), e.events.trigger("gamepadButtonRelease", se));
        }
        for (let Re in N.sticks) {
          let se = N.sticks[Re];
          if (!se) continue;
          let nt = new w(E.axes[se.x], E.axes[se.y]);
          ie.stickState.set(Re, nt), e.mergedGamepadState.stickState.set(Re, nt), e.events.trigger("gamepadStick", Re, nt);
        }
      }
    }
  }
  i(ka, "processGamepad");
  let Ue = {}, sr = {}, gn = {}, no = t.pixelDensity || window.devicePixelRatio || 1;
  Ue.mousemove = (h) => {
    let E = new w(h.offsetX, h.offsetY), R = new w(h.movementX, h.movementY);
    if (A()) {
      let N = e.canvas.width / no, ie = e.canvas.height / no, Re = window.innerWidth, se = window.innerHeight, nt = Re / se, bt = N / ie;
      if (nt > bt) {
        let Oe = se / ie, ar = (Re - N * Oe) / 2;
        E.x = De(h.offsetX - ar, 0, N * Oe, 0, N), E.y = De(h.offsetY, 0, ie * Oe, 0, ie);
      } else {
        let Oe = Re / N, ar = (se - ie * Oe) / 2;
        E.x = De(h.offsetX, 0, N * Oe, 0, N), E.y = De(h.offsetY - ar, 0, ie * Oe, 0, ie);
      }
    }
  ...
  Ue.mousedown = (h) => {
    e.events.onOnce("input", () => {
      var _a41;
      let E = ro[h.button];
      E && (e.lastInputDevice = "mouse", e.buttonsByMouse.has(E) && ((_a41 = e.buttonsByMouse.get(E)) == null ? void 0 : _a41.forEach((R) => {
    ...
    e.events.onOnce("input", () => {
      var _a41;
      let E = ro[h.button];
      E && (e.buttonsByMouse.has(E) && ((_a41 = e.buttonsByMouse.get(E)) == null ? void 0 : _a41.forEach((R) => {
        e.buttonState.release(R), e.events.trigger("buttonRelease", R);
      })), e.mouseState.release(E), e.events.trigger("mouseRelease", E));
    });
  };
  let _a40 = /* @__PURE__ */ new Set([" ", "ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Tab"]), oo = { ArrowLeft: "left", ArrowRight: "right", ArrowUp: "up", ArrowDown: "down", " ": "space" };
  Ue.keydown = (h) => {
    _a40.has(h.key) && h.preventDefault(), e.events.onOnce("input", () => {
      var _a41;
      let E = oo[h.key] || h.key.toLowerCase();
      if (E === void 0) throw new Error(`Unknown key: ${h.key}`);
      E.length === 1 ? (e.events.trigger("charInput", E), e.charInputted.push(E)) : E === "space" && (e.events.trigger("charInput", " "), e.charInputted.push(" ")), h.repeat ? (e.keyState.pressRepeat(E), e.events.trigger("keyPressRepeat", E)) : (e.lastInputDevice = "keyboard", e.buttonsByKey.has(E) && ((_a41 = e.buttonsByKey.get(E)) == null ? void 0 : _a41.forEach((R) => {
        e.buttonState.press(R), e.events.trigger("buttonPress", R);
    ...
    e.events.onOnce("input", () => {
      var _a41;
      let E = oo[h.key] || h.key.toLowerCase();
      e.buttonsByKey.has(E) && ((_a41 = e.buttonsByKey.get(E)) == null ? void 0 : _a41.forEach((R) => {
        e.buttonState.release(R), e.events.trigger("buttonRelease", R);
    ...
    h.preventDefault(), e.events.onOnce("input", () => {
      ...
      t.touchToMouse !== false && (e.mousePos = new w(E[0].clientX - R.x, E[0].clientY - R.y), e.lastInputDevice = "mouse", e.buttonsByMouse.has("left") && ((_a41 = e.buttonsByMouse.get("left")) == null ? void 0 : _a41.forEach((N) => {
    ...
    e.events.onOnce("input", () => {
      var _a41;
      let E = [...h.changedTouches], R = e.canvas.getBoundingClientRect();
      t.touchToMouse !== false && (e.mousePos = new w(E[0].clientX - R.x, E[0].clientY - R.y), e.mouseDeltaPos = new w(0, 0), e.buttonsByMouse.has("left") && ((_a41 = e.buttonsByMouse.get("left")) == null ? void 0 : _a41.forEach((N) => {
    ...
    e.events.onOnce("input", () => {
      let E = [...h.changedTouches], R = e.canvas.getBoundingClientRect();
      t.touchToMouse !== false && (e.mousePos = new w(E[0].clientX - R.x, E[0].clientY - R.y), e.mouseState.release("left"), e.events.trigger("mouseRelease", "left")), E.forEach((N) => {
        e.events.trigger("touchEnd", new w(N.clientX - R.x, N.clientY - R.y), N);
      });
    });
  }, Ue.wheel = (h) => {
  ...
  }, Ue.contextmenu = (h) => h.preventDefault(), sr.visibilitychange = () => {
  ...
  for (let [h, E] of Object.entries(Ue)) e.canvas.addEventListener(h, E);
  for (let [h, E] of Object.entries(sr)) document.addEventListener(h, E);
  for (let [h, E] of Object.entries(gn)) window.addEventListener(h, E);
  let io = new ResizeObserver((h) => {
    for (let E of h) if (E.target === e.canvas) {
  ...
  return io.observe(e.canvas), { dt: n, fixedDt: r, restDt: o, time: a, run: M, canvas: e.canvas, fps: l, numFrames: u, quit: V, isHidden: s, setFullscreen: v, isFullscreen: A, setCursor: c, screenshot: m, getGamepads: eo, getCursor: p, setCursorLocked: d, isCursorLocked: x, isTouchscreen: G, mousePos: F, mouseDeltaPos: g, isKeyDown: z, isKeyPressed: K, isKeyPressedRepeat: k, isKeyReleased: X, isMouseDown: S, isMousePressed: T, isMouseReleased: D, isMouseMoved: B, isGamepadButtonPressed: te, isGamepadButtonDown: Q, isGamepadButtonReleased: q, getGamepadStick: Ma, isButtonPressed: ae, isButtonDown: U, isButtonReleased: I, setButton: j, getButton: Y, charInputted: Ua, onResize: ue, onKeyDown: Z, onKeyPress: Ce, onKeyPressRepeat: Ht, onKeyRelease: lt, onMouseDown: nr, onMousePress: rr, onMouseRelease: or, onMouseMove: ir, onCharInput: dn, onTouchStart: Je, onTouchMove: mt, onTouchEnd: hn, onScroll: ke, onHide: qt, onShow: tt, onGamepadButtonDown: Va, onGamepadButtonPress: fn, onGamepadButtonRelease: Pa, onGamepadStick: Ra, onGamepadConnect: Ga, onGamepadDisconnect: Da, onButtonPress: Ba, onButtonDown: Fa, onButtonRelease: La, getLastInputDeviceType: Qo, events: e.events };
}, "initApp");
function Ve() {
...
function Or(t, e, n) {
  ...
  for (s.set(e, 0); r.length !== 0; ) {
    let a = (_a40 = r.remove()) == null ? void 0 : _a40.node;
    if (a === n) break;
    let l = t.getNeighbours(a);
    for (let u of l) {
      let m = (s.get(a) || 0) + t.getCost(a, u) + t.getHeuristic(u, n);
...
i(Lt, "calcTransform");
function ai(t) {
  return new w(t.x / he() * 2 - 1, -t.y / ye() * 2 + 1);
}
i(ai, "screen2ndc");
function Ct(t, e, n, r, o, s = 1) {
  ...
  for (let p = 0; p <= l; p++) a.push(t.add(e * m.x, n * m.y)), m = b(m.x * c.x - m.y * c.y, m.x * c.y + m.y * c.x);
  return a;
}
i(Ct, "getArcPts");
function ui(...t) {
...
function ci() {
  var _a40, _b;
  return ((_b = (_a40 = O.bgColor) == null ? void 0 : _a40.clone) == null ? void 0 : _b.call(_a40)) ?? null;
}
i(ci, "getBackground");
function ne(...t) {
...
function mi(t) {
  return new w(t.x * O.viewport.width / O.width, t.y * O.viewport.height / O.height);
}
i(mi, "contentToView");
function Au(t) {
  return new w((t.x - O.viewport.x) * he() / O.viewport.width, (t.y - O.viewport.y) * ye() / O.viewport.height);
}
...
var Su = en.reduce((t, e) => t + e.size, 0);
var di = 2048;
var hi = di * 4 * Su;
var fi = di * 6;
var gi = `
...
}, i(_a25, "TexPacker"), _a25);
function fe(t) {
  return typeof t != "string" || Sn(t) ? t : _.urlPrefix + t;
}
i(fe, "fixURL");
var _a26;
var me = (_a26 = class {
  constructor(e) {
    ...
    __publicField(this, "onLoadEvents", new le());
    __publicField(this, "onErrorEvents", new le());
    __publicField(this, "onFinishEvents", new le());
    e.then((n) => {
...
i(Rr, "fetchURL");
function Ot(t) {
  return Rr(t).then((e) => e.json());
}
i(Ot, "fetchJSON");
function Ti(t) {
  return Rr(t).then((e) => e.text());
}
i(Ti, "fetchText");
function Oi(t) {
  return Rr(t).then((e) => e.arrayBuffer());
}
i(Oi, "fetchArrayBuffer");
function Ai(t) {
  return t !== void 0 && (_.urlPrefix = t), _.urlPrefix;
}
i(Ai, "loadRoot");
function Si(t, e) {
  return _.custom.add(t, Ot(fe(e)));
}
i(Si, "loadJSON");
function At(t) {
  let e = new Image();
...
i(on, "load");
var Pi = i((t) => ({ urlPrefix: "", sprites: new ht(), fonts: new ht(), bitmapFonts: new ht(), sounds: new ht(), shaders: new ht(), custom: new ht(), music: {}, packer: new rn(t, 2048, 2048), loaded: false }), "initAssets");
...
var Ie = (_a28 = class {
  constructor(e, n, r = {}, o = null) {
    ...
    __publicField(this, "frames", [new $(0, 0, 1, 1)]);
  ...
  static fromImage(e, n = {}) {
    ...
    return new _a28(r, s, n.anims, n.slice9);
  }
  static fromURL(e, n = {}) {
    return At(e).then((r) => _a28.fromImage(r, n));
  }
}, i(_a28, "SpriteData"), _a28);
function It(t) {
  if (typeof t == "string") {
    let e = Gr(t);
    if (e) return e;
    ...
    if (t instanceof Ie) return me.loaded(t);
...
i(It, "resolveSprite");
function Gr(t) {
  return _.sprites.get(t) ?? null;
}
i(Gr, "getSprite");
function St(t, e, n = { sliceX: 1, sliceY: 1, anims: {} }) {
  return e = fe(e), Array.isArray(e) ? e.some((r) => typeof r == "string") ? _.sprites.add(t, Promise.all(e.map((r) => typeof r == "string" ? At(r) : Promise.resolve(r))).then((r) => Gi(r, n))) : _.sprites.addLoaded(t, Gi(e, n)) : typeof e == "string" ? _.sprites.add(t, Ie.from(e, n)) : _.sprites.addLoaded(t, Ie.fromImage(e, n));
}
i(St, "loadSprite");
function Dr(t = 1, e = 1, n = 0, r = 0, o = 1, s = 1) {
  let a = [], l = o / t, u = s / e;
  for (let m = 0; m < e; m++) for (let c = 0; c < t; c++) a.push(new $(n + c * l, r + m * u, l, u));
  return a;
}
i(Dr, "slice");
function Gi(t, e = {}) {
  ...
  return Ie.fromImage(a, { ...e, sliceX: t.length, sliceY: 1 });
}
...
i(Di, "loadBean");
function Mi(t, e, n) {
  e = fe(e), n = fe(n), typeof e == "string" && !n && (n = zo(e) + ".json");
  let r = typeof n == "string" ? Ot(n) : Promise.resolve(n);
  return _.sprites.add(t, r.then((o) => {
...
}, i(_a29, "FontData"), _a29);
function Mr(t) {
  if (!t) return Mr(re.font ?? pi);
  if (typeof t == "string") {
    let e = Fn(t), n = Ur(t);
  ...
  } else if (t instanceof me) return t.data ? t.data : t;
  return t;
}
i(Mr, "resolveFont");
function Ur(t) {
  return _.fonts.get(t) ?? null;
}
i(Ur, "getFont");
function Ui(t, e, n = {}) {
  let r = fe(e), o = new FontFace(t, typeof e == "string" ? `url(${r})` : r);
  return document.fonts.add(o), _.fonts.add(t, o.load().catch((s) => {
...
function Bi(t, e, n, r) {
  ...
  for (let [l, u] of a) s[u] = new $(l % o * e, Math.floor(l / o) * n, e, n);
  return { tex: t, map: s, size: n };
}
i(Bi, "makeFont");
function Fn(t) {
  return _.bitmapFonts.get(t) ?? null;
}
i(Fn, "getBitmapFont");
function Fi(t, e, n, r, o = {}) {
  let s = fe(e);
  return _.bitmapFonts.add(t, At(s).then((a) => Bi(Me.fromImage(O.ggl, a, o), n, r, o.chars ?? Bn)));
}
i(Fi, "loadBitmapFont");
function Li(t, e) {
  return e = fe(e), _.sprites.add(t, new Promise(async (n) => {
...
var Br = (_a30 = class {
  ...
  send(e) {
    ...
    for (let r in e) {
      ...
      else if (o instanceof w) n.uniform2f(s, o.x, o.y);
...
function Ln(t, e = tn, n = nn) {
  let r = gi.replace("{{user}}", e ?? tn), o = bi.replace("{{user}}", n ?? nn);
  try {
    return new Br(t, r, o, en.map((s) => s.name));
  } catch (s) {
...
i(Ii, "resolveShader");
function Fr(t) {
  return _.shaders.get(t) ?? null;
}
i(Fr, "getShader");
function ji(t, e, n) {
  return _.shaders.addLoaded(t, Ln(O.ggl, e, n));
}
i(ji, "loadShader");
function Ki(t, e, n) {
  e = fe(e), n = fe(n);
  let r = i((s) => s ? Ti(s) : Promise.resolve(null), "resolveUrl"), o = Promise.all([r(e), r(n)]).then(([s, a]) => Ln(O.ggl, s, a));
  return _.shaders.add(t, o);
}
i(Ki, "loadShaderURL");
var _a31;
var st = (_a31 = class {
  ...
  static fromArrayBuffer(e) {
    return new Promise((n, r) => oe.ctx.decodeAudioData(e, n, r)).then((n) => new _a31(n));
  }
  static fromURL(e) {
    return Sn(e) ? _a31.fromArrayBuffer(Ho(e)) : Oi(e).then((n) => _a31.fromArrayBuffer(n));
  }
}, i(_a31, "SoundData"), _a31);
function ki(t) {
  if (typeof t == "string") {
    let e = Lr(t);
    if (e) return e;
    ...
    if (t instanceof st) return me.loaded(t);
    if (t instanceof me) return t;
...
i(ki, "resolveSound");
function Lr(t) {
  return _.sounds.get(t) ?? null;
}
i(Lr, "getSound");
function _i(t, e) {
  return e = fe(e), _.sounds.add(t, typeof e == "string" ? st.fromURL(e) : st.fromArrayBuffer(e));
}
i(_i, "loadSound");
function Ni(t, e) {
  let n = fe(e), r = new Audio(n);
  return r.preload = "auto", _.music[t] = n;
}
i(Ni, "loadMusic");
function Ir(t, e) {
  return t = fe(t), typeof e == "string" ? on(new Promise((n, r) => {
    Ot(e).then((o) => {
      Ir(t, o).then(n).catch(r);
    });
  })) : on(Ie.from(t).then((n) => {
    let r = {};
    for (let o in e) {
...
function He(t) {
  ...
  let e = t.pts.length;
  if (!(e < 3)) {
    if (we(), ne(t.pos), it(t.scale), Qe(t.angle), ne(t.offset), t.fill !== false) {
      let n = t.color ?? H.WHITE, r = t.pts.map((s, a) => ({ pos: new w(s.x, s.y), uv: t.uv ? t.uv[a] : new w(0, 0), color: t.colors && t.colors[a] ? t.colors[a].mult(n) : n, opacity: t.opacity ?? 1 })), o;
      t.triangulate ? o = On(t.pts).map((a) => a.map((l) => t.pts.indexOf(l))).flat() : o = [...Array(e - 2).keys()].map((s) => [0, s + 1, s + 2]).flat(), je(r, t.indices ?? o, t.fixed, t.uv ? t.tex : O.defTex, t.shader, t.uniform ?? void 0);
    }
    t.outline && jt({ pts: [...t.pts, t.pts[0]], radius: t.radius, width: t.outline.width, color: t.outline.color, join: t.outline.join, uniform: t.uniform, fixed: t.fixed, opacity: t.opacity ?? t.outline.opacity }), xe();
  }
}
i(He, "drawPolygon");
function In(t) {
  ...
  let e = t.start ?? 0, n = t.end ?? 360, r = Ne(t.anchor ?? "center").scale(new w(-t.radiusX, -t.radiusY)), o = Ct(r, t.radiusX, t.radiusY, e, n, t.resolution);
  o.unshift(r);
  ...
  if (n - e >= 360 && t.outline) {
    t.fill !== false && He(Object.assign({}, s, { outline: null })), He(Object.assign({}, s, { pts: o.slice(1), fill: false }));
    return;
  }
  He(s);
}
...
function ft(t) {
  ...
  t.radius !== 0 && In(Object.assign({}, t, { radiusX: t.radius, radiusY: t.radius, angle: 0 }));
}
i(ft, "drawCircle");
function Kt(t) {
  let { p1: e, p2: n } = t;
  if (!e || !n) throw new Error('drawLine() requires properties "p1" and "p2".');
  let r = t.width || 1, o = n.sub(e).unit().normal().scale(r * 0.5), s = [e.sub(o), e.add(o), n.add(o), n.sub(o)].map((a) => ({ pos: new w(a.x, a.y), uv: new w(0), color: t.color ?? H.WHITE, opacity: t.opacity ?? 1 }));
  je(s, [0, 1, 3, 1, 2, 3], t.fixed, O.defTex, t.shader, t.uniform ?? void 0);
}
i(Kt, "drawLine");
function Pu(t) {
  let e = t.pts, n = [], r = (t.width || 1) * 0.5, o = e[0] === e[e.length - 1] || e[0].eq(e[e.length - 1]), s = t.pos || b(0, 0), a;
  ...
  if (!o) switch (t.cap) {
    ...
    case "round": {
      ...
      for (let M = 0; M < f; M++) n.push(c), n.push(c.sub(v)), v = b(v.x * A - v.y * V, v.x * V + v.y * A);
    }
  }
  for (let f = 1; f < e.length; f++) {
    if (c === e[f] || c.eq(e[f])) continue;
    m = c, c = e[f];
    ...
    let M = A.sub(u).cross(y) / V, G = u.add(a.scale(M));
    V > 0 ? (n.push(m.add(G)), n.push(m.sub(u)), n.push(m.add(G)), n.push(m.sub(A))) : (n.push(m.add(u)), n.push(m.sub(G)), n.push(m.add(A)), n.push(m.sub(G))), a = y, l = v, u = A;
  }
  if (!o) switch (n.push(c.add(u)), n.push(c.sub(u)), t.cap) {
    ...
    case "round": {
      let f = Math.max(r, 10), y = Math.PI / f, v = u.scale(1), A = Math.cos(y), V = Math.sin(y);
      for (let M = 0; M < f; M++) v = b(v.x * A - v.y * V, v.x * V + v.y * A), n.push(c), n.push(c.sub(v));
    }
  }
  if (n.length < 4) return;
  let p = n.map((f) => ({ pos: s.add(f), uv: b(), color: t.color || H.WHITE, opacity: t.opacity ?? 1 })), d = [], x = 0;
  for (let f = 0; f < n.length - 2; f += 2) d[x++] = f + 1, d[x++] = f, d[x++] = f + 2, d[x++] = f + 2, d[x++] = f + 3, d[x++] = f + 1;
  o && (d[x++] = n.length - 1, d[x++] = n.length - 2, d[x++] = 0, d[x++] = 0, d[x++] = 1, d[x++] = n.length - 1), je(p, d, t.fixed, O.defTex, t.shader, t.uniform ?? void 0);
}
...
function Ru(t) {
  ...
  for (let f = 1; f < e.length; f++) {
    ...
    let M = A.sub(u).cross(y) / V, G = u.add(a.scale(M));
    if (V > 0) {
      let F = m.add(G), g = Math.max(r, 10), T = ce(u.angleBetween(A) / g), S = u, D = Math.cos(T), B = Math.sin(T);
      for (let K = 0; K < g; K++) n.push(F), n.push(m.sub(S)), S = b(S.x * D - S.y * B, S.x * B + S.y * D);
    } else {
      let F = m.sub(G), g = Math.max(r, 10), T = ce(u.angleBetween(A) / g), S = u, D = Math.cos(T), B = Math.sin(T);
      for (let K = 0; K < g; K++) n.push(m.add(S)), n.push(F), S = b(S.x * D - S.y * B, S.x * B + S.y * D);
    }
    a = y, l = v, u = A;
  }
  if (!o) switch (n.push(c.add(u)), n.push(c.sub(u)), t.cap) {
...
function Gu(t) {
  ...
  for (let f = 1; f < e.length; f++) {
    ...
    let M = A.sub(u).cross(y) / V, G = u.add(a.scale(M));
    n.push(m.add(G)), n.push(m.sub(G)), a = y, l = v, u = A;
  }
  if (!o) switch (n.push(c.add(u)), n.push(c.sub(u)), t.cap) {
    case "square": {
      let f = a.scale(r / l);
...
function jt(t) {
  ...
  if (!(e.length < 2)) {
    ...
    } else for (let r = 0; r < e.length - 1; r++) Kt(Object.assign({}, t, { p1: e[r], p2: e[r + 1] })), t.join !== "none" && ft(Object.assign({}, t, { pos: e[r], radius: n / 2 }));
  }
}
i(jt, "drawLines");
function jn(t, e) {
...
i(jn, "drawCurve");
function Hi(t) {
  jn((e) => Xt(t.pt1, t.pt2, t.pt3, t.pt4, e), t);
}
i(Hi, "drawBezier");
var _a32;
var Me = (_a32 = class {
...
var Kn = (_a34 = class {
  ...
  flush() {
    ...
    let e = this.ctx.gl;
    this.ctx.pushArrayBuffer(this.glVBuf), e.bufferSubData(e.ARRAY_BUFFER, 0, new Float32Array(this.vqueue)), this.ctx.pushElementArrayBuffer(this.glIBuf), e.bufferSubData(e.ELEMENT_ARRAY_BUFFER, 0, new Uint16Array(this.iqueue)), this.ctx.setVertexFormat(this.vertexFormat), this.curShader.bind(), this.curShader.send(this.curUniform), (_a40 = this.curTex) == null ? void 0 : _a40.bind(), e.drawElements(this.curPrimitive, this.iqueue.length, e.UNSIGNED_SHORT, 0), (_b = this.curTex) == null ? void 0 : _b.unbind(), this.curShader.unbind(), this.ctx.popArrayBuffer(), this.ctx.popElementArrayBuffer(), this.vqueue = [], this.iqueue = [], this.numDraws++;
  }
  free() {
    let e = this.ctx.gl;
    e.deleteBuffer(this.glVBuf), e.deleteBuffer(this.glIBuf);
  }
}, i(_a34, "BatchRenderer"), _a34);
function Pt(t) {
  let e = [], n = i((s) => {
    e.push(s), t(s);
  }, "push"), r = i(() => {
...
function qi(t, e = {}) {
  ...
  function a(F) {
    ...
    F.reduce((T, S, D) => (t.vertexAttribPointer(D, S.size, t.FLOAT, false, g * 4, T), t.enableVertexAttribArray(D), T + S.size * 4), 0);
  }
  i(a, "setVertexFormat");
  let [l, u] = Pt((F) => t.bindTexture(t.TEXTURE_2D, F)), [m, c] = Pt((F) => t.bindBuffer(t.ARRAY_BUFFER, F)), [p, d] = Pt((F) => t.bindBuffer(t.ELEMENT_ARRAY_BUFFER, F)), [x, f] = Pt((F) => t.bindFramebuffer(t.FRAMEBUFFER, F)), [y, v] = Pt((F) => t.bindRenderbuffer(t.RENDERBUFFER, F)), [A, V] = Pt((F) => {
    if (!F) return;
    let { x: g, y: T, w: S, h: D } = F;
    t.viewport(g, T, S, D);
  }), [M, G] = Pt((F) => t.useProgram(F));
...
var jr = {};
function Wi(t, e) {
  e.pos && (t.pos = t.pos.add(e.pos)), e.scale && (t.scale = t.scale.scale(b(e.scale))), e.angle && (t.angle += e.angle), e.color && t.ch.length === 1 && (t.color = t.color.mult(e.color)), e.opacity && (t.opacity *= e.opacity);
}
i(Wi, "applyCharTransform");
function $i(t) {
  let e = {}, n = "", r = [], o = 0, s = 0;
  for (let a = 0; a < t.length; a++) if (a !== o + 1 && (s += a - o), o = a, !(t[a] === "\\" && t[a + 1] === "[")) {
    if ((a === 0 || t[a - 1] !== "\\") && t[a] === "[") {
      let l = a;
      a++;
      let u = t[a] === "/", m = "";
      for (u && a++; a < t.length && t[a] !== "]"; ) m += t[a++];
      if (!vi.test(m) || a >= t.length || t[a] !== "]" || u && (r.length === 0 || r[r.length - 1][0] !== m)) a = l;
      else {
        u ? r.pop() : r.push([m, l]);
        continue;
      }
    }
    n += t[a], r.length > 0 && (e[a - s] = r.map(([l]) => l));
  }
  if (r.length > 0) {
    for (; r.length > 0; ) {
      let [a, l] = r.pop();
      t = t.substring(0, l) + "\\" + t.substring(l);
    }
    return $i(t);
  }
...
function qe(t) {
  ...
  let e = Mr(t.font);
  if (t.text === "" || e instanceof me || !e) return { width: 0, height: 0, chars: [], opt: t };
  let { charStyleMap: n, text: r } = $i(t.text + ""), o = $o(r);
  if (e instanceof Vt || typeof e == "string") {
    let V = e instanceof Vt ? e.fontface.family : e, M = e instanceof Vt ? { outline: e.outline, filter: e.filter } : { outline: null, filter: Zt }, G = jr[V] ?? { font: { tex: new Me(O.ggl, 2048, 2048, { filter: M.filter }), map: {}, size: 64 }, cursor: new w(0), outline: M.outline };
    jr[V] || (jr[V] = G), e = G.font;
    for (let F of o) if (!G.font.map[F]) {
      let g = Kr;
      if (!g) throw new Error("fontCacheC2d is not defined.");
      if (!gt) throw new Error("fontCacheCanvas is not defined.");
      ...
      if (!S) continue;
      let D = e.size;
      G.outline && G.outline.width && G.outline.color && (g.lineJoin = "round", g.lineWidth = G.outline.width * 2, g.strokeStyle = G.outline.color.toHex(), g.strokeText(F, G.outline.width, G.outline.width), S += G.outline.width * 2, D += G.outline.width * 3), g.fillText(F, ((_a40 = G.outline) == null ? void 0 : _a40.width) ?? 0, ((_b = G.outline) == null ? void 0 : _b.width) ?? 0);
      let B = g.getImageData(0, 0, S, D);
      if (G.cursor.x + S > 2048 && (G.cursor.x = 0, G.cursor.y += D, G.cursor.y > 2048)) throw new Error("Font atlas exceeds character limit");
      e.tex.update(B, G.cursor.x, G.cursor.y), e.map[F] = new $(G.cursor.x, G.cursor.y, S, D), G.cursor.x += S;
    }
  }
  let s = t.size || e.size, a = b(t.scale ?? 1).scale(s / e.size), l = t.lineSpacing ?? 0, u = t.letterSpacing ?? 0, m = 0, c = 0, p = 0, d = [], x = [], f = 0, y = null, v = 0;
  for (; f < o.length; ) {
    let V = o[f];
    if (V === `
`) p += s + l, d.push({ width: m - u, chars: x }), y = null, v = 0, m = 0, x = [];
      ...
      if (M) {
        let G = M.w * a.x;
        t.width && m + G > t.width && (p += s + l, y != null && (f -= x.length - y, V = o[f], M = e.map[V], G = M.w * a.x, x = x.slice(0, y - 1), m = v), y = null, v = 0, d.push({ width: m - u, chars: x }), m = 0, x = []), x.push({ tex: e.tex, width: M.w, height: M.h, quad: new $(M.x / e.tex.width, M.y / e.tex.height, M.w / e.tex.width, M.h / e.tex.height), ch: V, pos: new w(m, p), opacity: t.opacity ?? 1, color: t.color ?? H.WHITE, scale: b(a), angle: 0 }), V === " " && (y = x.length, v = m), m += G, c = Math.max(c, m), m += u;
      }
    }
    f++;
  }
  d.push({ width: m - u, chars: x }), p += s, t.width && (c = t.width);
  let A = [];
  for (let V = 0; V < d.length; V++) {
    let M = (c - d[V].width) * ni(t.align ?? "left");
    for (let G of d[V].chars) {
      let F = e.map[G.ch], g = A.length + V;
      if (G.pos = G.pos.add(M, 0).add(F.w * a.x * 0.5, F.h * a.y * 0.5), t.transform) {
        let T = typeof t.transform == "function" ? t.transform(g, G.ch) : t.transform;
        T && Wi(G, T);
      }
      if (n[g]) {
        let T = n[g];
        for (let S of T) {
          let D = (_c = t.styles) == null ? void 0 : _c[S], B = typeof D == "function" ? D(g, G.ch) : D;
          B && Wi(G, B);
        }
      }
      A.push(G);
  ...
  return { width: c, height: p, chars: A, opt: t };
}
i(qe, "formatText");
function ut(t) {
  if (t.width === void 0 || t.height === void 0) throw new Error('drawUVQuad() requires property "width" and "height".');
  if (t.width <= 0 || t.height <= 0) return;
  let e = t.width, n = t.height, o = Ne(t.anchor || dt).scale(new w(e, n).scale(-0.5)), s = t.quad || new $(0, 0, 1, 1), a = t.color || W(255, 255, 255), l = t.opacity ?? 1, u = t.tex ? 0.1 / t.tex.width : 0, m = t.tex ? 0.1 / t.tex.height : 0, c = s.x + u, p = s.y + m, d = s.w - u * 2, x = s.h - m * 2;
  we(), ne(t.pos), Qe(t.angle), it(t.scale), ne(o), je([{ pos: new w(-e / 2, n / 2), uv: new w(t.flipX ? c + d : c, t.flipY ? p : p + x), color: a, opacity: l }, { pos: new w(-e / 2, -n / 2), uv: new w(t.flipX ? c + d : c, t.flipY ? p + x : p), color: a, opacity: l }, { pos: new w(e / 2, -n / 2), uv: new w(t.flipX ? c : c + d, t.flipY ? p + x : p), color: a, opacity: l }, { pos: new w(e / 2, n / 2), uv: new w(t.flipX ? c : c + d, t.flipY ? p : p + x), color: a, opacity: l }], [0, 1, 3, 1, 2, 3], t.fixed, t.tex, t.shader, t.uniform ?? void 0), xe();
}
i(ut, "drawUVQuad");
function ze(t) {
  we(), ne(t.opt.pos), Qe(t.opt.angle), ne(Ne(t.opt.anchor ?? "topleft").add(1, 1).scale(t.width, t.height).scale(-0.5)), t.chars.forEach((e) => {
    ut({ tex: e.tex, width: e.width, height: e.height, pos: e.pos, scale: e.scale, angle: e.angle, color: e.color, opacity: e.opacity, quad: e.quad, anchor: "center", uniform: t.opt.uniform, shader: t.opt.shader, fixed: t.opt.fixed });
  }), xe();
}
...
function Pe(t) {
  ...
  if (t.width <= 0 || t.height <= 0) return;
  let e = t.width, n = t.height, o = Ne(t.anchor || dt).add(1, 1).scale(new w(e, n).scale(-0.5)), s = [new w(0, 0), new w(e, 0), new w(e, n), new w(0, n)];
  if (t.radius) {
  ...
  He(Object.assign({}, t, { offset: o, pts: s, ...t.gradient ? { colors: t.horizontal ? [t.gradient[0], t.gradient[1], t.gradient[1], t.gradient[0]] : [t.gradient[0], t.gradient[0], t.gradient[1], t.gradient[1]] } : {} }));
}
i(Pe, "drawRect");
function Ye(t) {
  Te();
  let e = O.width, n = O.height;
  O.width = O.viewport.width, O.height = O.viewport.height, t(), Te(), O.width = e, O.height = n;
}
i(Ye, "drawUnscaled");
function kr(t, e) {
  Ye(() => {
    ...
    t.x + o >= he() && ne(b(-o, 0)), t.y + s >= ye() && ne(b(0, -s)), Pe({ width: o, height: s, color: W(0, 0, 0), radius: 4, opacity: 0.8, fixed: true }), ze(r), xe();
  });
}
i(kr, "drawInspectText");
function kn(t) {
  if (!t.p1 || !t.p2 || !t.p3) throw new Error('drawTriangle() requires properties "p1", "p2" and "p3".');
  return He(Object.assign({}, t, { pts: [t.p1, t.p2, t.p3] }));
}
i(kn, "drawTriangle");
function Qi() {
  if (J.inspect) {
    let t = null;
    for (let e of C.root.get("*", { recursive: true })) if (e.c("area") && e.isHovering()) {
      t = e;
      break;
    }
...
`));
  ...
  J.paused && Ye(() => {
    we(), ne(he(), 0), ne(-8, 8);
    let t = 32;
    Pe({ width: t, height: t, anchor: "topright", color: W(0, 0, 0), opacity: 0.8, radius: 4, fixed: true });
    for (let e = 1; e <= 2; e++) Pe({ width: 4, height: t * 0.6, anchor: "center", pos: b(-t / 3 * e, t * 0.5), color: W(255, 255, 255), radius: 2, fixed: true });
    xe();
  }), J.timeScale !== 1 && Ye(() => {
    we(), ne(he(), ye()), ne(-8, -8);
    let t = 8, e = qe({ text: J.timeScale.toFixed(1), font: Tt, size: 16, color: W(255, 255, 255), pos: b(-t), anchor: "botright", fixed: true });
    Pe({ width: e.width + t * 2 + t * 4, height: e.height + t * 2, anchor: "botright", color: W(0, 0, 0), opacity: 0.8, radius: 4, fixed: true });
    for (let n = 0; n < 2; n++) {
      let r = J.timeScale < 1;
      kn({ p1: b(-e.width - t * (r ? 2 : 3.5), -t), p2: b(-e.width - t * (r ? 2 : 3.5), -t - e.height), p3: b(-e.width - t * (r ? 3.5 : 2), -t - e.height / 2), pos: b(-n * t * 1 + (r ? -t * 0.5 : 0), 0), color: W(255, 255, 255), fixed: true });
    }
    ze(e), xe();
  }), J.curRecording && Ye(() => {
    we(), ne(0, ye()), ne(24, -24), ft({ radius: 12, color: W(255, 0, 0), opacity: xn(0, 1, P.time() * 4), fixed: true }), xe();
    ...
    for (let r of C.logs) {
      ...
      o += `[time]${r.time.toFixed(2)}[/time]`, o += " ", o += `[${s}]${((_a40 = r.msg) == null ? void 0 : _a40.toString) ? r.msg.toString() : r.msg}[/${s}]`, e.push(o);
    }
    C.logs = C.logs.filter((r) => P.time() - r.time < (re.logTime || 4));
    let n = qe({ text: e.join(`
`), font: Tt, pos: b(t, -t), anchor: "botleft", size: 16, width: he() * 0.6, lineSpacing: t / 2, fixed: true, styles: { time: { color: W(127, 127, 127) }, info: { color: W(255, 255, 255) }, error: { color: W(255, 0, 127) } } });
    Pe({ width: n.width + t * 2, height: n.height + t * 2, anchor: "botleft", color: W(0, 0, 0), radius: 4, opacity: 0.8, fixed: true }), ze(n), xe();
  });
}
i(Qi, "drawDebug");
function Ji() {
  let t = C.cam, e = w.fromAngle(be(0, 360)).scale(t.shake);
  t.shake = Ee(t.shake, 0, 5 * Ve()), t.transform = new ge().translate(Et()).scale(t.scale).rotate(t.angle).translate((t.pos ?? Et()).scale(-1).add(e)), C.root.draw(), Te();
}
i(Ji, "drawFrame");
function Zi() {
  let t = Le();
  C.events.numListeners("loading") > 0 ? C.events.trigger("loading", t) : Ye(() => {
    let e = he() / 2, n = 24, r = b(he() / 2, ye() / 2).sub(b(e / 2, n / 2));
    Pe({ pos: b(0), width: he(), height: ye(), color: W(0, 0, 0) }), Pe({ pos: r, width: e, height: n, fill: false, outline: { width: 4 } }), Pe({ pos: r, width: e * t, height: n });
  });
}
i(Zi, "drawLoadScreen");
function _n(t, e, n) {
  let r = O.ggl.gl;
  Te(), r.clear(r.STENCIL_BUFFER_BIT), r.enable(r.STENCIL_TEST), r.stencilFunc(r.NEVER, 1, 255), r.stencilOp(r.REPLACE, r.REPLACE, r.REPLACE), e(), Te(), r.stencilFunc(n, 1, 255), r.stencilOp(r.KEEP, r.KEEP, r.KEEP), t(), Te(), r.disable(r.STENCIL_TEST);
}
i(_n, "drawStenciled");
function es(t, e) {
  let n = O.ggl.gl;
...
function Rt(t) {
  ...
  let e = t.quad ?? new $(0, 0, 1, 1), n = t.tex.width * e.w, r = t.tex.height * e.h, o = new w(1);
  if (t.tiled) {
    let a = Ne(t.anchor || dt).add(new w(1, 1)).scale(0.5).scale(t.width || n, t.height || r), l = (t.width || n) / n, u = (t.height || r) / r, m = Math.floor(l), c = Math.floor(u), p = l - m, d = u - c, x = (m + p ? 1 : 0) * (c + d ? 1 : 0), f = new Array(x * 6), y = new Array(x * 4), v = 0, A = i((V, M, G, F, g) => {
      f[v * 6 + 0] = v * 4 + 0, f[v * 6 + 1] = v * 4 + 1, f[v * 6 + 2] = v * 4 + 3, f[v * 6 + 3] = v * 4 + 1, f[v * 6 + 4] = v * 4 + 2, f[v * 6 + 5] = v * 4 + 3, y[v * 4 + 0] = { pos: new w(V - a.x, M - a.y), uv: new w(g.x, g.y), color: t.color || H.WHITE, opacity: t.opacity || 1 }, y[v * 4 + 1] = { pos: new w(V + G - a.x, M - a.y), uv: new w(g.x + g.w, g.y), color: t.color || H.WHITE, opacity: t.opacity || 1 }, y[v * 4 + 2] = { pos: new w(V + G - a.x, M + F - a.y), uv: new w(g.x + g.w, g.y + g.h), color: t.color || H.WHITE, opacity: t.opacity || 1 }, y[v * 4 + 3] = { pos: new w(V - a.x, M + F - a.y), uv: new w(g.x, g.y + g.h), color: t.color || H.WHITE, opacity: t.opacity || 1 }, v++;
    }, "addQuad");
    for (let V = 0; V < c; V++) {
      for (let M = 0; M < m; M++) A(M * n, V * r, n, r, e);
      p && A(m * n, V * r, n * p, r, new $(e.x, e.y, e.w * p, e.h));
    }
    if (d) {
      for (let V = 0; V < m; V++) A(V * n, c * r, n, r * d, new $(e.x, e.y, e.w, e.h * d));
      p && A(m * n, c * r, n * p, r * d, new $(e.x, e.y, e.w * p, e.h * d));
    }
    je(y, f, t.fixed, t.tex, t.shader, t.uniform ?? void 0);
  } else t.width && t.height ? (o.x = t.width / n, o.y = t.height / r) : t.width ? (o.x = t.width / n, o.y = o.x) : t.height && (o.y = t.height / r, o.x = o.y), ut(Object.assign({}, t, { scale: o.scale(t.scale || new w(1)), tex: t.tex, quad: e, width: n, height: r }));
}
i(Rt, "drawTexture");
function ts(t) {
  ...
  Rt(Object.assign({}, t, { tex: e.data.tex, quad: n.scale(t.quad ?? new $(0, 0, 1, 1)) }));
}
i(ts, "drawSprite");
function ns(t, e) {
  let n = O.ggl.gl;
...
i(_r, "drawText");
var rs = i((t, e) => {
  let n = Ln(e, tn, nn), r = window.devicePixelRatio || window.devicePixelRatio, o = t.scale ?? 1, { gl: s } = e, a = Me.fromImage(e, new ImageData(new Uint8ClampedArray([255, 255, 255, 255]), 1, 1)), l = t.width && t.height ? new at(e, t.width * r * o, t.height * r * o) : new at(e, s.drawingBufferWidth, s.drawingBufferHeight), u = null, m = 1;
  t.background && (typeof t.background == "string" ? u = W(t.background) : (u = W(...t.background), m = t.background[3] ?? 1), s.clearColor(u.r / 255, u.g / 255, u.b / 255, m ?? 1)), s.enable(s.BLEND), s.blendFuncSeparate(s.SRC_ALPHA, s.ONE_MINUS_SRC_ALPHA, s.ONE, s.ONE_MINUS_SRC_ALPHA);
...
function Nn() {
  let t = We, e = O.ggl.gl.drawingBufferWidth / t, n = O.ggl.gl.drawingBufferHeight / t;
  if (re.letterbox) {
    if (!re.width || !re.height) throw new Error("Letterboxing requires width and height defined.");
  ...
  if (re.stretch && (!re.width || !re.height)) throw new Error("Stretching requires width and height defined.");
  O.viewport = { x: 0, y: 0, width: e, height: n };
}
i(Nn, "updateViewport");
function ct(t) {
  return t.fixed ? true : t.parent ? ct(t.parent) : false;
}
i(ct, "isFixed");
function Ke(t) {
...
i(os, "circle");
function Hn(...t) {
  return { id: "color", color: W(...t), inspect() {
...
function ss(t = 1) {
  ...
  return { require: ["opacity"], add() {
    ...
    r || (n += Ve(), this.opacity = De(n, 0, t, 0, e), n >= t && (this.opacity = e, r = true));
  } };
}
i(ss, "fadeIn");
...
i(as, "mask");
function qn(t) {
  return { id: "opacity", opacity: t ?? 1, fadeIn(e = 1, n = L.easings.linear) {
...
i(qn, "opacity");
function us(t = 1, e = W(0, 0, 0), n = 1, r = "miter", o = 10, s = "butt") {
...
var Nr = (_a35 = class {
  constructor() {
    __publicField(this, "pos", b(0));
    __publicField(this, "vel", b(0));
    __publicField(this, "acc", b(0));
...
}, i(_a35, "Particle"), _a35);
function cs(t, e) {
  let n = e.lifetime, r = [], o = t.colors || [H.WHITE], s = t.opacities || [1], a = t.quads || [new $(0, 0, 1, 1)], l = t.scales || [1], u = t.lifeTime, m = e.direction, c = e.spread, p = t.speed || [0, 0], d = t.angle || [0, 0], x = t.angularVelocity || [0, 0], f = t.acceleration || [b(0), b(0)], y = t.damping || [0, 0], v = [], A = new Array(t.max), V = 0, M = 0;
  for (let g = 0; g < t.max; g++) {
    v[g * 6 + 0] = g * 4 + 0, v[g * 6 + 1] = g * 4 + 1, v[g * 6 + 2] = g * 4 + 3, v[g * 6 + 3] = g * 4 + 1, v[g * 6 + 4] = g * 4 + 2, v[g * 6 + 5] = g * 4 + 3;
    for (let T = 0; T < 4; T++) A[g * 4 + T] = { pos: new w(0, 0), uv: new w(0, 0), color: W(255, 255, 255), opacity: 1 };
    r[g] = new Nr();
  }
  let G = new le();
  function F(g = 0) {
  ...
  return i(F, "nextFree"), { id: "particles", emit(g) {
    let T = 0;
    for (let S = 0; S < g; S++) {
      if (T = F(T), T == null) return;
      let D = be(m - c, m + c), B = w.fromAngle(D).scale(be(p[0], p[1])), K = be(d[0], d[1]), k = be(x[0], x[1]), z = b(be(f[0].x, f[1].x), be(f[0].y, f[1].y)), X = be(y[0], y[1]), te = u ? be(u[0], u[1]) : null, Q = e.shape ? e.shape.random() : b(), q = r[T];
      q.lt = te, q.pos = Q, q.vel = B, q.acc = z, q.angle = K, q.angularVelocity = k, q.damping = X, q.angularVelocity = k, q.gc = false;
    }
    V += g;
  }, update() {
    if (n !== void 0 && n <= 0) return;
    let g = Ve();
    for (let T of r) if (!T.gc) {
    ...
    for (n !== void 0 && (n -= g, n <= 0 && G.trigger()), M += g; V < t.max && e.rate && M > e.rate; ) this.emit(1), V++, M -= e.rate;
  }, draw() {
    if (!(n !== void 0 && n <= 0)) {
      for (let g = 0; g < r.length; g++) {
        let T = r[g];
        if (T.gc) continue;
        let S = T.progress, D = Math.floor(T.progress * o.length), B = D < o.length - 1 ? Ee(o[D], o[D + 1], De(S, D / o.length, (D + 1) / o.length, 0, 1)) : o[D], K = Math.floor(T.progress * s.length), k = K < s.length - 1 ? Ee(s[K], s[K + 1], De(S, K / s.length, (K + 1) / s.length, 0, 1)) : s[K], z = Math.floor(T.progress * a.length), X = a[z], te = Math.floor(T.progress * l.length), Q = l[te], q = Math.cos(T.angle * Math.PI / 180), ae = Math.sin(T.angle * Math.PI / 180), U = (t.texture ? t.texture.width : 10) * X.w / 2, I = (t.texture ? t.texture.height : 10) * X.h / 2, Y = g * 4, j = A[Y];
        j.pos.x = T.pos.x + -U * Q * q - -I * Q * ae, j.pos.y = T.pos.y + -U * Q * ae + -I * Q * q, j.uv.x = X.x, j.uv.y = X.y, j.color.r = B.r, j.color.g = B.g, j.color.b = B.b, j.opacity = k, j = A[Y + 1], j.pos.x = T.pos.x + U * Q * q - -I * Q * ae, j.pos.y = T.pos.y + U * Q * ae + -I * Q * q, j.uv.x = X.x + X.w, j.uv.y = X.y, j.color.r = B.r, j.color.g = B.g, j.color.b = B.b, j.opacity = k, j = A[Y + 2], j.pos.x = T.pos.x + U * Q * q - I * Q * ae, j.pos.y = T.pos.y + U * Q * ae + I * Q * q, j.uv.x = X.x + X.w, j.uv.y = X.y + X.h, j.color.r = B.r, j.color.g = B.g, j.color.b = B.b, j.opacity = k, j = A[Y + 3], j.pos.x = T.pos.x + -U * Q * q - I * Q * ae, j.pos.y = T.pos.y + -U * Q * ae + I * Q * q, j.uv.x = X.x, j.uv.y = X.y + X.h, j.color.r = B.r, j.color.g = B.g, j.color.b = B.b, j.opacity = k;
      }
      je(A, v, this.fixed, t.texture, this.shader, this.uniform);
    }
  }, onEnd(g) {
    return G.add(g);
  }, inspect() {
...
function Yn(t, e, n = {}) {
  return { id: "rect", width: t, height: e, radius: n.radius || 0, draw() {
    Pe(Object.assign(Ke(this), { width: this.width, height: this.height, radius: this.radius, fill: n.fill }));
  }, renderArea() {
...
i(ms, "shader");
function ps(...t) {
  return t.length > 0 && (C.cam.pos = b(...t)), C.cam.pos ? C.cam.pos.clone() : Et();
}
i(ps, "camPos");
function ds(...t) {
  return t.length > 0 && (C.cam.scale = b(...t)), C.cam.scale.clone();
}
i(ds, "camScale");
function hs(t) {
...
i(hs, "camRot");
function fs(t = W(255, 255, 255), e = 1) {
  let n = C.root.add([Yn(he(), ye()), Hn(t), qn(1), $n()]), r = n.fadeOut(e);
...
function vs(t, e) {
  ...
  let n = C.root.add([Gt(e.pos ?? b(0))]), r = t.length, o = 0, s = null, a = null, l = null, u = null, m = i((g) => g.x + g.y * o, "tile2Hash"), c = i((g) => b(Math.floor(g % o), Math.floor(g / o)), "hash2Tile"), p = i(() => {
    s = [];
    for (let g of n.children) d(g);
    ...
    for (let S = 0; S < g.length; S++) {
      ...
      if (D) {
        let B = D.length, K = 15;
        for (let k = 0; k < B; k++) K |= D[k].edgeMask;
        l[S] = K;
      }
    }
  }, "createEdgeMap"), A = i(() => {
  ...
  }, "createConnectivityMap"), V = i((g, T) => a[T], "getCost"), M = i((g, T) => {
    let S = c(g), D = c(T);
    return S.dist(D);
  }, "getHeuristic"), G = i((g, T) => {
    let S = [], D = Math.floor(g % o), B = D > 0 && l[g] & 1 && a[g - 1] !== 1 / 0, K = g >= o && l[g] & 2 && a[g - o] !== 1 / 0, k = D < o - 1 && l[g] & 4 && a[g + 1] !== 1 / 0, z = g < o * r - o - 1 && l[g] & 8 && a[g + o] !== 1 / 0;
    return T ? (B && (K && S.push(g - o - 1), S.push(g - 1), z && S.push(g + o - 1)), K && S.push(g - o), k && (K && S.push(g - o + 1), S.push(g + 1), z && S.push(g + o + 1)), z && S.push(g + o)) : (B && S.push(g - 1), K && S.push(g - o), k && S.push(g + 1), z && S.push(g + o)), S;
    ...
    let S = b(...T), D = (() => {
      if (typeof g == "string") {
        if (e.tiles[g]) {
          if (typeof e.tiles[g] != "function") throw new Error("Level symbol def must be a function returning a component list");
          return e.tiles[g](S);
        } else if (e.wildcardTile) return e.wildcardTile(g, S);
      } else {
    ...
    if (!D) return null;
    let B = false, K = false;
    for (let z of D) z.id === "tile" && (K = true), z.id === "pos" && (B = true);
    B || D.push(Gt()), K || D.push(Xn());
    let k = n.add(D);
    return B && (k.tilePosOffset = k.pos.clone()), k.tilePos = S, s && (d(k), this.trigger("spatialMapChanged"), this.trigger("navigationMapInvalid")), k;
  }, numColumns() {
    return o;
  }, numRows() {
    return r;
    ...
    let S = g.scale(1 / this.tileWidth(), 1 / this.tileHeight()), D = Co(S, T, (B) => {
      let K = this.getAt(B);
      if (K.some((z) => z.isObstacle)) return true;
      let k = null;
      for (let z of K) if (z.is("area")) {
        let te = z.worldArea().raycast(g, T);
        te && (k ? te.fraction < k.fraction && (k = te, k.object = z) : (k = te, k.object = z));
      }
      return k || false;
    }, 64);
    ...
    var _a40;
    if (a || y(), l || v(), u || A(), g.x < 0 || g.x >= o || g.y < 0 || g.y >= r || T.x < 0 || T.x >= o || T.y < 0 || T.y >= r) return null;
    let D = m(g), B = m(T);
    if (a[B] === 1 / 0) return null;
    if (D === B) return [];
    if (u[D] != -1 && u[D] !== u[B]) return null;
    let K = new Ft((q, ae) => q.cost < ae.cost);
    K.insert({ cost: 0, node: D });
    let k = /* @__PURE__ */ new Map();
    k.set(D, D);
    let z = /* @__PURE__ */ new Map();
    for (z.set(D, 0); K.length !== 0; ) {
      let q = (_a40 = K.remove()) == null ? void 0 : _a40.node;
      if (q === B) break;
      let ae = G(q, S.allowDiagonals);
      for (let U of ae) {
        let I = (z.get(q) || 0) + V(q, U) + M(U, B);
        (!z.has(U) || I < z.get(U)) && (z.set(U, I), K.insert({ cost: I, node: U }), k.set(U, q));
      }
    }
    let X = [], te = B, Q = c(te);
    for (X.push(Q); te !== D; ) {
      let q = k.get(te);
      if (!q) throw new Error("Bug in pathfinding algorithm");
      te = q;
      let ae = c(te);
      X.push(ae);
    }
    ...
    let D = this.tileWidth(), B = this.tileHeight(), K = this.getTilePath(this.pos2Tile(g), this.pos2Tile(T), S);
    return K ? [g, ...K.slice(1, -1).map((k) => k.scale(D, B).add(D / 2, B / 2)), T] : null;
  } };
...
i(vs, "addLevel");
function et(t, e, n) {
  return C.objEvents.registers[t] || (C.objEvents.registers[t] = new Qt()), C.objEvents.on(t, (r, ...o) => {
    r.is(e) && n(r, ...o);
  });
}
i(et, "on");
var ws = de((t) => {
  let e = C.root.add([{ update: t }]);
  return { get paused() {
    return e.paused;
  }, set paused(n) {
    e.paused = n;
  }, cancel: i(() => e.destroy(), "cancel") };
}, (t, e) => et("fixedUpdate", t, e));
var Cs = de((t) => {
  let e = C.root.add([{ update: t }]);
  return { get paused() {
    return e.paused;
...
var Hr = de((t) => C.events.on("add", t), (t, e) => et("add", t, e));
var Ts = de((t) => C.events.on("destroy", t), (t, e) => et("destroy", t, e));
function Os(t, e, n) {
  return et("collide", t, (r, o, s) => o.is(e) && n(r, o, s));
}
i(Os, "onCollide");
function As(t, e, n) {
  return et("collideUpdate", t, (r, o, s) => o.is(e) && n(r, o, s));
}
i(As, "onCollideUpdate");
function Ss(t, e, n) {
  return et("collideEnd", t, (r, o, s) => o.is(e) && n(r, o, s));
}
i(Ss, "onCollideEnd");
function Qn(t, e) {
  C.root.get(t, { recursive: true }).forEach(e), Hr(t, e);
}
i(Qn, "forAllCurrentAndFuture");
var Vs = de((t) => P.onMousePress(t), (t, e) => {
  let n = [];
  return Qn(t, (r) => {
...
i(kt, "onLoad");
function un(t = []) {
  let e = /* @__PURE__ */ new Map(), n = [], r = {}, o = new $e(), s = [], a = null, l = false, u = { id: Xo(), hidden: false, transform: new ge(), children: [], parent: null, set paused(c) {
    if (c !== l) {
      l = c;
    ...
    let c = [];
    for (let [p, d] of e.entries()) Object.keys(d).length == 1 && c.push(p);
    return c;
  }, add(c) {
    ...
    this.canvas && (Te(), this.canvas.bind());
    let c = O.fixed;
    this.fixed && (O.fixed = true), we(), ne(this.pos), it(this.scale), Qe(this.angle);
    ...
    } else this.trigger("draw"), p.forEach((d) => d.draw());
    xe(), O.fixed = c, this.canvas && (Te(), this.canvas.unbind());
  }, drawInspect() {
    this.hidden || (we(), ne(this.pos), it(this.scale), Qe(this.angle), this.children.forEach((c) => c.drawInspect()), this.trigger("drawInspect"), xe());
  }, use(c) {
    if (!c) return;
    if (No(c) && (c = new c(this)), typeof c == "function") return this.use(c(this));
    if (typeof c == "string") return this.use({ id: c });
    let p = [];
    c.id ? (this.unuse(c.id), r[c.id] = [], p = r[c.id], e.set(c.id, c)) : n.push(c);
    for (let x in c) {
      if (yi.has(x)) continue;
      let f = Object.getOwnPropertyDescriptor(c, x);
      if (f) if (typeof f.value == "function" && (c[x] = c[x].bind(this)), f.set && Object.defineProperty(c, x, { set: f.set.bind(this) }), f.get && Object.defineProperty(c, x, { get: f.get.bind(this) }), xi.has(x)) {
        let y = x === "add" ? () => {
          var _a40;
          a = i((v) => p.push(v), "onCurCompCleanup"), (_a40 = c[x]) == null ? void 0 : _a40.call(c), a = null;
        } : c[x];
        p.push(this.on(x, y).cancel);
      } else if (this[x] === void 0) Object.defineProperty(this, x, { get: i(() => c[x], "get"), set: i((y) => c[x] = y, "set"), configurable: true, enumerable: true }), p.push(() => delete this[x]);
    ...
    var _a40;
    let c = {};
    for (let [p, d] of e) c[p] = ((_a40 = d.inspect) == null ? void 0 : _a40.call(d)) ?? null;
    for (let [p, d] of n.entries()) {
      if (d.inspect) {
        c[p] = d.inspect();
        continue;
      }
      for (let [x, f] of Object.entries(d)) typeof f != "function" && (c[x] = `${x}: ${f}`);
    }
    return c;
  }, onAdd(c) {
  ...
  for (let c of m) u[c] = (...p) => {
    var _a40;
    let d = (_a40 = P[c]) == null ? void 0 : _a40.call(P, ...p);
...
i(un, "make");
var Bs = i(() => ({ events: new $e(), objEvents: new $e(), root: un([]), gravity: null, scenes: {}, currentScene: null, layers: null, defaultLayerIndex: 0, logs: [], cam: { pos: null, scale: new w(1), angle: 0, shake: 0, transform: new ge() } }), "initGame");
function Fs(t) {
  C.gravity = t ? (C.gravity || b(0, 1)).unit().scale(t) : null;
}
i(Fs, "setGravity");
function Ls() {
...
i(Ls, "getGravity");
function Is(t) {
  C.gravity = t.unit().scale(C.gravity ? C.gravity.len() : 1);
}
...
i(ks, "playMusic");
function Jn(t, e = {}) {
  if (typeof t == "string" && _.music[t]) return ks(_.music[t], e);
  ...
  o.loop = !!e.loop, o.detune.value = e.detune ?? 0, o.playbackRate.value = e.speed ?? 1, o.connect(a), o.onended = () => {
    var _a40;
    x() >= (((_a40 = o.buffer) == null ? void 0 : _a40.duration) ?? Number.POSITIVE_INFINITY) && s.trigger();
  ...
  return { stop() {
    ...
    if (r !== y) if (r = y, y) c && (o.stop(), c = false), m = n.currentTime;
    else {
      o = f(o);
      let v = m - u;
    ...
    var _a40;
    ((_a40 = o.buffer) == null ? void 0 : _a40.duration) && (y > o.buffer.duration || (r ? (o = f(o), u = m - y) : (o.stop(), o = f(o), u = n.currentTime - y, o.start(0, y), c = true, m = 0)));
  }, set speed(y) {
    ...
    var _a40;
    return ((_a40 = o.buffer) == null ? void 0 : _a40.duration) ?? 0;
  }, time() {
...
i(Jn, "play");
function Zn(t) {
  return Jn(oe.burpSnd, t);
}
i(Zn, "burp");
function _s(t) {
  return t !== void 0 && (oe.masterNode.gain.value = t), oe.masterNode.gain.value;
}
i(_s, "volume");
function er() {
  P.onHide(() => {
    ...
    let t = re.width && re.height;
    t && !re.stretch && !re.letterbox || (ve.width = ve.offsetWidth * We, ve.height = ve.offsetHeight * We, Nn(), t || (O.frameBuffer.free(), O.frameBuffer = new at(O.ggl, O.ggl.gl.drawingBufferWidth, O.ggl.gl.drawingBufferHeight), O.width = O.ggl.gl.drawingBufferWidth / We / _t, O.height = O.ggl.gl.drawingBufferHeight / We / _t));
...
i(er, "initEvents");
function Ns(t, e = {}) {
  let n = C.root.add([Gt(t), tr()]), r = (e.speed || 1) * 5, o = e.scale || 1;
...
i(Ns, "addKaboom");
var Hs = i(function(t, e) {
  if (C.layers) throw Error("Layers can only be assigned once.");
  let n = t.indexOf(e);
  if (n == -1) throw Error("The default layer name should be present in the layers list.");
  C.layers = t, C.defaultLayerIndex = n;
}, "layers");
function Wn(t) {
  t.destroy();
}
...
function Ys(t, ...e) {
  ...
  C.events.onOnce("frameEnd", () => {
    C.events.trigger("sceneLeave", t), P.events.clear(), C.events.clear(), C.objEvents.clear(), [...C.root.children].forEach((n) => {
      (!n.stay || n.scenesToStay && !n.scenesToStay.includes(t)) && C.root.remove(n);
    }), C.root.clearEvents(), er(), C.cam = { pos: null, scale: b(1), angle: 0, shake: 0, transform: new ge() }, C.scenes[t](...e);
  }), C.currentScene = t;
}
i(Ys, "go");
function Ws(t) {
...
function cn(t, e = {}) {
  ...
  return { id: "sprite", width: 0, height: 0, frame: e.frame || 0, quad: e.quad || new $(0, 0, 1, 1), animSpeed: e.animSpeed ?? 1, flipX: e.flipX ?? false, flipY: e.flipY ?? false, get sprite() {
    ...
    } else Rt(Object.assign(Ke(this), { tex: n.tex, quad: u.scale(this.quad ?? new $(0, 0, 1, 1)), flipX: this.flipX, flipY: this.flipY, tiled: e.tiled, width: this.width, height: this.height }));
  }, add() {
    let u = It(t);
    u ? u.onLoad((m) => l(this, m)) : kt(() => l(this, It(t).data));
  }, update() {
    ...
    r.timer += Ve() * this.animSpeed, r.timer >= 1 / r.speed && (r.timer = 0, this.frame += o, (this.frame < Math.min(u.from, u.to) || this.frame > Math.max(u.from, u.to)) && (r.loop ? r.pingpong ? (this.frame -= o, o *= -1, this.frame += o) : this.frame = u.from : r.pingpong ? o === Math.sign(u.to - u.from) ? (this.frame = u.to, o *= -1, this.frame += o) : (this.frame = u.from, r.onEnd(), this.stop()) : (this.frame = u.to, r.onEnd(), this.stop())));
  }, play(u, m = {}) {
    if (!n) {
      s.add(() => this.play(u, m));
      return;
...
function Xs(t, e = {}) {
  function n(o) {
    ...
    return e.width || (o.width = s.width / (((_a40 = o.scale) == null ? void 0 : _a40.x) || 1)), o.height = s.height / (((_b = o.scale) == null ? void 0 : _b.y) || 1), s;
  }
  i(n, "update");
...
function Zs(t) {
  ...
  return { id: "navigator", require: ["pos"], navigateTo(n) {
    var _a40;
    return (_a40 = this.graph) == null ? void 0 : _a40.getWaypointPath(this.pos, n, t.navigationOpt);
  }, get graph() {
    if (e) return e;
    let n = this.parent;
    for (; n; ) {
      if (n.is("navigatormap")) return n.graph;
      n = n.parent;
    }
  }, set graph(n) {
    e = n;
...
i(ea, "patrol");
function ta(t, e = {}) {
  let n = typeof t == "function" ? t : () => C.root.query(t), r = e.checkFrequency || 1, o = typeof e.direction == "number" ? w.fromAngle(e.direction) : e.direction, s = 0;
...
i(ta, "sentry");
function Xn(t = {}) {
  let e = b(0), n = t.isObstacle ?? false, r = t.cost ?? 0, o = t.edges ?? [], s = i(() => {
    let l = { left: 1, top: 2, right: 4, bottom: 8 };
    return o.map((u) => l[u] || 0).reduce((u, m) => u | m, 0);
  }, "getEdgeMask"), a = s();
  return { id: "tile", tilePosOffset: t.offset ?? b(0), set tilePos(l) {
    let u = this.getLevel();
...
}, i(_a36, "AnimateChannel"), _a36);
function na(t, e) {
  return e.add(e.sub(t));
}
i(na, "reflect");
var _a37;
var $r = (_a37 = class extends pn {
  constructor(e, n, r, o) {
    super(e, r, o);
...
}, i(_a37, "AnimateChannelNumber"), _a37);
var _a38;
var Xr = (_a38 = class extends pn {
  constructor(e, n, r, o, s) {
    ...
    if (this.keys = n, this.interpolation === "spline") {
      ...
      for (let a = 0; a < this.keys.length - 1; a++) {
        ...
        this.curves.push(Bt(c, l, m, p)), s && ((_a40 = this.dcurves) == null ? void 0 : _a40.push(Bt(c, l, m, p, Mo)));
      }
    }
  }
  update(e, n) {
...
}, i(_a38, "AnimateChannelVec2"), _a38);
var _a39;
var Qr = (_a39 = class extends pn {
  constructor(e, n, r, o) {
    super(e, r, o);
    __publicField(this, "keys");
    this.keys = n;
...
}, i(_a39, "AnimateChannelColor"), _a39);
function ra(t = {}) {
  let e = [], n = 0, r = false;
  return { id: "animate", require: t.followMotion ? ["rotate"] : void 0, base: { pos: b(0, 0), angle: 0, scale: b(1, 1), opacity: 1 }, add() {
    ...
    r = false, this.unanimate(o), typeof s[0] == "number" ? e.push(new $r(o, s, a, t.relative || false)) : s[0] instanceof w ? e.push(new Xr(o, s, a, t.relative || false, o === "pos" && (t.followMotion || false))) : s[0] instanceof H && e.push(new Qr(o, s, a, t.relative || false));
  }, unanimate(o) {
...
function Jr(t, e) {
  let n = { name: t.name };
  return t.is("animate") && (n.channels = t.serializeAnimationChannels(), Object.assign(n, t.serializeAnimationOptions())), t.children.length > 0 && (n.children = t.children.filter((r) => r.is("named")).map((r) => Jr(r, r.name))), n;
}
...
function zr(t = 2, e = 1) {
  ...
  return { require: ["scale"], update() {
    ...
    r < 0 && this.destroy(), this.scale = b(r), n += Ve();
  } };
}
i(zr, "boom");
function oa(t, e) {
...
function ia(t, e = {}) {
  ...
  return { id: "lifespan", require: ["opacity"], async add() {
    await C.root.wait(t), this.opacity = this.opacity ?? 1, n > 0 && await C.root.tween(this.opacity, 0, n, (r) => this.opacity = r, ot.linear), this.destroy();
  } };
}
i(ia, "lifespan");
function sa(t) {
...
function aa(t, e, n) {
  ...
  return { id: "state", state: t, enterState(u, ...m) {
    ...
    if (n) {
      ...
      if (!p.includes(u)) throw new Error(`Cannot transition state from "${c}" to "${u}". Available transitions: ${p.map((d) => `"${d}"`).join(", ")}`);
    }
...
function mn() {
  return { id: "timer", wait(t, e) {
    ...
    let r = 0, o = this.onUpdate(() => {
      r += L.dt(), r >= t && (n.forEach((s) => s()), o.cancel());
    });
    return { get paused() {
      return o.paused;
    }, set paused(s) {
  ...
  }, tween(t, e, n, r, o = ot.linear) {
    let s = 0, a = [], l = this.onUpdate(() => {
      s += L.dt();
      let u = Math.min(s / n, 1);
      r(Ee(t, e, o(u))), u === 1 && (l.cancel(), r(e), a.forEach((m) => m()));
    });
    return { get paused() {
      return l.paused;
    }, set paused(u) {
...
function la(t = {}) {
  ...
  return { id: "area", collisionIgnore: t.collisionIgnore ?? [], add() {
  ...
  }, area: { shape: t.shape ?? null, scale: t.scale ? b(t.scale) : b(1), offset: t.offset ?? b(0), cursor: t.cursor ?? null }, isClicked() {
    ...
    if (r instanceof L.Rect) {
      let s = Ne(this.anchor || dt).add(1, 1).scale(-0.5).scale(r.width, r.height);
      o.translate(s);
    }
...
function ma(t = {}) {
  ...
  return { id: "body", require: ["pos"], vel: b(0), drag: t.drag ?? 0, jumpForce: t.jumpForce ?? Ci, gravityScale: t.gravityScale ?? 1, isStatic: t.isStatic ?? false, mass: t.mass ?? 1, add() {
    ...
    e && (!this.isColliding(e) || !e.exists() || !e.is("body") ? r = true : (n && !e.pos.eq(n) && t.stickToPlatform !== false && this.moveBy(e.pos.sub(n)), n = e.pos));
    let u = L.restDt();
...
function da(t) {
  return { id: "surfaceEffector", require: ["area"], speed: t.speed, speedVariation: t.speedVariation ?? 0, forceScale: t.speedVariation ?? 0.9, add() {
    this.onCollideUpdate((e, n) => {
      var _a40;
      let r = n == null ? void 0 : n.normal.normal(), o = e.vel.project(r), a = (_a40 = r == null ? void 0 : r.scale(this.speed)) == null ? void 0 : _a40.sub(o);
...
i($n, "fixed");
function ya(t, e) {
  return { id: "follow", require: ["pos"], follow: { obj: t, offset: e ?? b(0) }, add() {
...
function xa(t) {
  var _a40;
  let e = (_a40 = C.layers) == null ? void 0 : _a40.indexOf(t);
  return { id: "layer", get layerIndex() {
    return e ?? null;
  }, get layer() {
    var _a41;
    return e ? ((_a41 = C.layers) == null ? void 0 : _a41[e]) ?? null : null;
  }, set layer(n) {
    var _a41;
    if (e = (_a41 = C.layers) == null ? void 0 : _a41.indexOf(n), e == -1) throw Error("Invalid layer name");
  }, inspect() {
...
i(xa, "layer");
function va(t, e) {
  let n = typeof t == "number" ? w.fromAngle(t) : t.unit();
...
i(wa, "offscreen");
function Gt(...t) {
  return { id: "pos", pos: b(...t), moveBy(...e) {
    this.pos = this.pos.add(b(...e));
  }, move(...e) {
    this.moveBy(b(...e).scale(L.dt()));
  }, moveTo(...e) {
    if (typeof e[0] == "number" && typeof e[1] == "number") return this.moveTo(b(e[0], e[1]), e[2]);
    let n = e[0], r = e[1];
    if (r === void 0) {
      this.pos = b(n);
      return;
...
function Nt(...t) {
  ...
  return { id: "scale", set scale(n) {
    if (!(n instanceof w)) throw Error("The scale property on scale is a vector. Use scaleTo or scaleBy to set the scale with a number.");
    e = b(n);
  }, get scale() {
    return e;
  }, scaleTo(...n) {
...
var Sa = i((t = {}) => {
  ...
  e === document.body && (document.body.style.width = "100%", document.body.style.height = "100%", document.body.style.margin = "0px", document.documentElement.style.width = "100%", document.documentElement.style.height = "100%"), ve = t.canvas ?? e.appendChild(document.createElement("canvas")), _t = t.scale ?? 1;
  let n = t.width && t.height && !t.stretch && !t.letterbox;
  n ? (ve.width = t.width * _t, ve.height = t.height * _t) : (ve.width = ve.parentElement.offsetWidth, ve.height = ve.parentElement.offsetHeight);
  let r = ["outline: none", "cursor: default"];
  if (n) {
    let U = ve.width, I = ve.height;
    r.push(`width: ${U}px`), r.push(`height: ${I}px`);
  } else r.push("width: 100%"), r.push("height: 100%");
  t.crisp && (r.push("image-rendering: pixelated"), r.push("image-rendering: crisp-edges")), ve.style.cssText = r.join(";"), We = t.pixelDensity || window.devicePixelRatio, ve.width *= We, ve.height *= We, ve.tabIndex = 0, gt = document.createElement("canvas"), gt.width = 256, gt.height = 256, Kr = gt.getContext("2d", { willReadFrequently: true }), P = Zo({ canvas: ve, touchToMouse: t.touchToMouse, gamepads: t.gamepads, pixelDensity: t.pixelDensity, maxFPS: t.maxFPS, buttons: t.buttons });
  ...
  let a = s, l = qi(a, { texFilter: t.texFilter });
  O = rs(t, l), oe = Ks(), _ = Pi(l), C = Bs(), C.root.use(mn());
  function u(U, I) {
    let Y = new at(l, U, I);
    return { clear: i(() => Y.clear(), "clear"), free: i(() => Y.free(), "free"), toDataURL: i(() => Y.toDataURL(), "toDataURL"), toImageData: i(() => Y.toImageData(), "toImageData"), width: Y.width, height: Y.height, draw: i((j) => {
      Te(), Y.bind(), j(), Te(), Y.unbind();
    }, "draw") };
  }
  i(u, "makeCanvas");
  function m() {
    a.clear(a.COLOR_BUFFER_BIT), O.frameBuffer.bind(), a.clear(a.COLOR_BUFFER_BIT), O.bgColor || Ye(() => {
      ut({ width: he(), height: ye(), quad: new $(0, 0, he() / 64, ye() / 64), tex: O.bgTex, fixed: true });
    }), O.renderer.numDraws = 0, O.fixed = false, O.transformStack.length = 0, O.transform = new ge();
  }
  i(m, "frameStart");
  function c(U, I) {
    O.postShader = U, O.postShaderUniform = I ?? null;
  }
  i(c, "usePostEffect");
  function p() {
    Te(), O.lastDrawCalls = O.renderer.numDraws, O.frameBuffer.unbind(), a.viewport(0, 0, a.drawingBufferWidth, a.drawingBufferHeight);
    let U = O.width, I = O.height;
    O.width = a.drawingBufferWidth / We, O.height = a.drawingBufferHeight / We, Rt({ flipY: true, tex: O.frameBuffer.tex, pos: new w(O.viewport.x, O.viewport.y), width: O.viewport.width, height: O.viewport.height, shader: O.postShader, uniform: typeof O.postShaderUniform == "function" ? O.postShaderUniform() : O.postShaderUniform, fixed: true }), Te(), O.width = U, O.height = I;
  }
  i(p, "frameEnd");
  let d = false;
  J = { inspect: false, timeScale: 1, showLog: true, fps: i(() => P.fps(), "fps"), numFrames: i(() => P.numFrames(), "numFrames"), stepFrame: K, drawCalls: i(() => O.lastDrawCalls, "drawCalls"), clearLog: i(() => C.logs = [], "clearLog"), log: i((U) => {
    let I = t.logMax ?? 8;
    C.logs.unshift({ msg: U, time: P.time() }), C.logs.length > I && (C.logs = C.logs.slice(0, I));
  }, "log"), error: i((U) => J.log(new Error(U.toString ? U.toString() : U)), "error"), curRecording: null, numObjects: i(() => F("*", { recursive: true }).length, "numObjects"), get paused() {
    return d;
  }, set paused(U) {
    d = U, U ? oe.ctx.suspend() : oe.ctx.resume();
  } };
  function x(U, I) {
    try {
      return JSON.parse(window.localStorage[U]);
    } catch {
      return I ? (f(U, I), I) : null;
    }
  }
  i(x, "getData");
  function f(U, I) {
    window.localStorage[U] = JSON.stringify(I);
  }
  i(f, "setData");
  function y(U, ...I) {
    let Y = U(L), j;
    typeof Y == "function" ? j = Y(...I)(L) : j = Y;
    for (let ue in j) L[ue] = j[ue], t.global !== false && (window[ue] = j[ue]);
    return L;
  }
  i(y, "plug");
  function v(U) {
    let I = P.canvas.captureStream(U), Y = oe.ctx.createMediaStreamDestination();
  ...
  i(A, "isFocused");
  let V = C.root.add.bind(C.root), M = C.root.readd.bind(C.root), G = C.root.removeAll.bind(C.root), F = C.root.get.bind(C.root), g = C.root.wait.bind(C.root), T = C.root.loop.bind(C.root), S = C.root.query.bind(C.root), D = C.root.tween.bind(C.root);
  ...
  const _k = class _k {
    ...
    reverse() {
      return new _k(this.target, this.source, this.normal.scale(-1), this.distance, this.resolved);
    }
    hasOverlap() {
  ...
  function z() {
    if (!ca()) return;
    let U = {}, I = t.hashGridSize || 64, Y = new ge(), j = [];
    function ue(Z) {
      if (j.push(Y.clone()), Z.pos && Y.translate(Z.pos), Z.scale && Y.scale(Z.scale), Z.angle && Y.rotate(Z.angle), Z.transform = Y.clone(), Z.c("area") && !Z.paused) {
        let Ce = Z, lt = Ce.worldArea().bbox(), nr = Math.floor(lt.pos.x / I), rr = Math.floor(lt.pos.y / I), or = Math.ceil((lt.pos.x + lt.width) / I), ir = Math.ceil((lt.pos.y + lt.height) / I), dn = /* @__PURE__ */ new Set();
        for (let Je = nr; Je <= or; Je++) for (let mt = rr; mt <= ir; mt++) if (!U[Je]) U[Je] = {}, U[Je][mt] = [Ce];
        else if (!U[Je][mt]) U[Je][mt] = [Ce];
        else {
          let hn = U[Je][mt];
          e: for (let ke of hn) {
            if (ke.paused || !ke.exists() || dn.has(ke.id)) continue;
            for (let tt of Ce.collisionIgnore) if (ke.is(tt)) continue e;
            for (let tt of ke.collisionIgnore) if (Ce.is(tt)) continue e;
            let qt = Lo(Ce.worldArea(), ke.worldArea());
            if (qt) {
              let tt = new k(Ce, ke, qt.normal, qt.distance);
              Ce.trigger("collideUpdate", ke, tt);
              let fn = tt.reverse();
              fn.resolved = tt.resolved, ke.trigger("collideUpdate", Ce, fn);
            }
            dn.add(ke.id);
          }
          hn.push(Ce);
  ...
  i(z, "checkFrame");
  function X(U) {
    console.error(U), oe.ctx.suspend();
    let I = U.message ?? String(U) ?? "Unknown error, check console for more info";
    P.run(() => {
    }, () => {
      m(), Ye(() => {
        let ue = he(), Z = ye(), Ce = { size: 36, width: ue - 32 * 2, letterSpacing: 4, lineSpacing: 4, font: Tt, fixed: true };
        Pe({ width: ue, height: Z, color: W(0, 0, 255), fixed: true });
        let Ht = qe({ ...Ce, text: "Error", pos: b(32), color: W(255, 128, 0), fixed: true });
        ze(Ht), _r({ ...Ce, text: I, pos: b(32, 32 + Ht.height + 16), fixed: true }), xe(), C.events.trigger("error", U);
      }), p();
    });
  }
  i(X, "handleErr");
  ...
  function Q() {
    C.events.onOnce("frameEnd", () => {
      ...
      let U = a.getParameter(a.MAX_TEXTURE_IMAGE_UNITS);
      for (let I = 0; I < U; I++) a.activeTexture(a.TEXTURE0 + I), a.bindTexture(a.TEXTURE_2D, null), a.bindTexture(a.TEXTURE_CUBE_MAP, null);
